...
static_assert(sizeof(FArtifactSettings) == 0x000080, "Wrong size on FArtifactSettings");
...
static_assert(offsetof(FArtifactSettings, OnlineEnvironment) == 0x000070, "Member 'FArtifactSettings::OnlineEnvironment' has a wrong offset!");
