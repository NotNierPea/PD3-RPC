...
void UWBP_UI_SM_GameStart_C::OnPhotosensitivityConfirmed(class FName ClosingActionName)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_UI_SM_GameStart_C", "OnPhotosensitivityConfirmed");

	Params::WBP_UI_SM_GameStart_C_OnPhotosensitivityConfirmed Parms{};
...
// Function WBP_UI_SM_GameStart.WBP_UI_SM_GameStart_C.ShowPhotosensitivityPopup
// (BlueprintCallable, BlueprintEvent)

void UWBP_UI_SM_GameStart_C::ShowPhotosensitivityPopup()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_UI_SM_GameStart_C", "ShowPhotosensitivityPopup");
