...
public:
	...
	TMulticastInlineDelegate<void()>              XRTrackingOriginChangedDelegate;                   // 0x0150(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              XRPlayAreaChangedDelegate;                         // 0x0160(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UVRNotificationsComponent, XRTrackingOriginChangedDelegate) == 0x000150, "Member 'UVRNotificationsComponent::XRTrackingOriginChangedDelegate' has a wrong offset!");
static_assert(offsetof(UVRNotificationsComponent, XRPlayAreaChangedDelegate) == 0x000160, "Member 'UVRNotificationsComponent::XRPlayAreaChangedDelegate' has a wrong offset!");
