...
static_assert(alignof(AIPerceptionComponent_SetAllSenseEnabled) == 0x000001, "Wrong alignment on AIPerceptionComponent_SetAllSenseEnabled");
static_assert(sizeof(AIPerceptionComponent_SetAllSenseEnabled) == 0x000001, "Wrong size on AIPerceptionComponent_SetAllSenseEnabled");
static_assert(offsetof(AIPerceptionComponent_SetAllSenseEnabled, bEnable) == 0x000000, "Member 'AIPerceptionComponent_SetAllSenseEnabled::bEnable' has a wrong offset!");
...
static_assert(alignof(CrowdFollowingComponent_SetCrowdSimplified) == 0x000001, "Wrong alignment on CrowdFollowingComponent_SetCrowdSimplified");
static_assert(sizeof(CrowdFollowingComponent_SetCrowdSimplified) == 0x000002, "Wrong size on CrowdFollowingComponent_SetCrowdSimplified");
static_assert(offsetof(CrowdFollowingComponent_SetCrowdSimplified, bEnable) == 0x000000, "Member 'CrowdFollowingComponent_SetCrowdSimplified::bEnable' has a wrong offset!");
static_assert(offsetof(CrowdFollowingComponent_SetCrowdSimplified, bUpdateAgent) == 0x000001, "Member 'CrowdFollowingComponent_SetCrowdSimplified::bUpdateAgent' has a wrong offset!");
