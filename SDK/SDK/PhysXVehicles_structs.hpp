...
static_assert(sizeof(FAnimNode_WheelHandler) == 0x000100, "Wrong size on FAnimNode_WheelHandler");
...
static_assert(sizeof(FWheelSetup) == 0x000028, "Wrong size on FWheelSetup");
...
static_assert(offsetof(FWheelSetup, AdditionalOffset) == 0x000014, "Member 'FWheelSetup::AdditionalOffset' has a wrong offset!");
static_assert(offsetof(FWheelSetup, bDisableSteering) == 0x000020, "Member 'FWheelSetup::bDisableSteering' has a wrong offset!");
