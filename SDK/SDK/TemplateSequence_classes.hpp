...
static_assert(sizeof(UTemplateSequenceSection) == 0x000188, "Wrong size on UTemplateSequenceSection");
static_assert(offsetof(UTemplateSequenceSection, PropertyScales) == 0x000178, "Member 'UTemplateSequenceSection::PropertyScales' has a wrong offset!");
...
static_assert(offsetof(USequenceCameraShakeCameraStandIn, AspectRatio) == 0x000040, "Member 'USequenceCameraShakeCameraStandIn::AspectRatio' has a wrong offset!");
static_assert(offsetof(USequenceCameraShakeCameraStandIn, PostProcessSettings) == 0x000050, "Member 'USequenceCameraShakeCameraStandIn::PostProcessSettings' has a wrong offset!");
static_assert(offsetof(USequenceCameraShakeCameraStandIn, PostProcessBlendWeight) == 0x0005C0, "Member 'USequenceCameraShakeCameraStandIn::PostProcessBlendWeight' has a wrong offset!");
static_assert(offsetof(USequenceCameraShakeCameraStandIn, Filmback) == 0x0005C4, "Member 'USequenceCameraShakeCameraStandIn::Filmback' has a wrong offset!");
static_assert(offsetof(USequenceCameraShakeCameraStandIn, LensSettings) == 0x0005D0, "Member 'USequenceCameraShakeCameraStandIn::LensSettings' has a wrong offset!");
static_assert(offsetof(USequenceCameraShakeCameraStandIn, FocusSettings) == 0x0005E8, "Member 'USequenceCameraShakeCameraStandIn::FocusSettings' has a wrong offset!");
...
static_assert(offsetof(USequenceCameraShakeSequencePlayer, BoundObjectOverride) == 0x0002D8, "Member 'USequenceCameraShakeSequencePlayer::BoundObjectOverride' has a wrong offset!");
static_assert(offsetof(USequenceCameraShakeSequencePlayer, Sequence) == 0x0002E0, "Member 'USequenceCameraShakeSequencePlayer::Sequence' has a wrong offset!");
static_assert(offsetof(USequenceCameraShakeSequencePlayer, RootTemplateInstance) == 0x0002E8, "Member 'USequenceCameraShakeSequencePlayer::RootTemplateInstance' has a wrong offset!");
