...
static_assert(alignof(SBZGridlyTask_DownloadGridlyNativeCulture_DownloadLocalizedTexts) == 0x000008, "Wrong alignment on SBZGridlyTask_DownloadGridlyNativeCulture_DownloadLocalizedTexts");
...
static_assert(offsetof(SBZGridlyTask_DownloadGridlyNativeCulture_DownloadLocalizedTexts, WorldContextObject) == 0x000000, "Member 'SBZGridlyTask_DownloadGridlyNativeCulture_DownloadLocalizedTexts::WorldContextObject' has a wrong offset!");
static_assert(offsetof(SBZGridlyTask_DownloadGridlyNativeCulture_DownloadLocalizedTexts, ReturnValue) == 0x000008, "Member 'SBZGridlyTask_DownloadGridlyNativeCulture_DownloadLocalizedTexts::ReturnValue' has a wrong offset!");
