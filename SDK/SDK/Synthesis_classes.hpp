...
static_assert(sizeof(UModularSynthComponent) == 0x000DB0, "Wrong size on UModularSynthComponent");
static_assert(offsetof(UModularSynthComponent, VoiceCount) == 0x0006F0, "Member 'UModularSynthComponent::VoiceCount' has a wrong offset!");
...
static_assert(sizeof(UGranularSynth) == 0x000AB0, "Wrong size on UGranularSynth");
static_assert(offsetof(UGranularSynth, GranulatedSoundWave) == 0x0006F0, "Member 'UGranularSynth::GranulatedSoundWave' has a wrong offset!");
...
static_assert(sizeof(USynthComponentMonoWaveTable) == 0x000E30, "Wrong size on USynthComponentMonoWaveTable");
static_assert(offsetof(USynthComponentMonoWaveTable, OnTableAltered) == 0x0006F0, "Member 'USynthComponentMonoWaveTable::OnTableAltered' has a wrong offset!");
static_assert(offsetof(USynthComponentMonoWaveTable, OnNumTablesChanged) == 0x000700, "Member 'USynthComponentMonoWaveTable::OnNumTablesChanged' has a wrong offset!");
static_assert(offsetof(USynthComponentMonoWaveTable, CurrentPreset) == 0x000710, "Member 'USynthComponentMonoWaveTable::CurrentPreset' has a wrong offset!");
...
static_assert(offsetof(USynthComponentToneGenerator, Frequency) == 0x0006F0, "Member 'USynthComponentToneGenerator::Frequency' has a wrong offset!");
static_assert(offsetof(USynthComponentToneGenerator, Volume) == 0x0006F4, "Member 'USynthComponentToneGenerator::Volume' has a wrong offset!");
...
static_assert(sizeof(USynthSamplePlayer) == 0x000820, "Wrong size on USynthSamplePlayer");
static_assert(offsetof(USynthSamplePlayer, SoundWave) == 0x0006F0, "Member 'USynthSamplePlayer::SoundWave' has a wrong offset!");
static_assert(offsetof(USynthSamplePlayer, OnSampleLoaded) == 0x0006F8, "Member 'USynthSamplePlayer::OnSampleLoaded' has a wrong offset!");
static_assert(offsetof(USynthSamplePlayer, OnSamplePlaybackProgress) == 0x000708, "Member 'USynthSamplePlayer::OnSamplePlaybackProgress' has a wrong offset!");
