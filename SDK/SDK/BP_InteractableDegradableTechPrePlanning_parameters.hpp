...
struct BP_InteractableDegradableTechPrePlanning_C_ExecuteUbergraph_BP_InteractableDegradableTechPrePlanning final
{
public:
	...
	class UNiagaraComponent*                      CallFunc_SpawnSystemAtLocation_ReturnValue_1;      // 0x00B0(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(BP_InteractableDegradableTechPrePlanning_C_ExecuteUbergraph_BP_InteractableDegradableTechPrePlanning) == 0x000008, "Wrong alignment on BP_InteractableDegradableTechPrePlanning_C_ExecuteUbergraph_BP_InteractableDegradableTechPrePlanning");
static_assert(sizeof(BP_InteractableDegradableTechPrePlanning_C_ExecuteUbergraph_BP_InteractableDegradableTechPrePlanning) == 0x0000B8, "Wrong size on BP_InteractableDegradableTechPrePlanning_C_ExecuteUbergraph_BP_InteractableDegradableTechPrePlanning");
static_assert(offsetof(BP_InteractableDegradableTechPrePlanning_C_ExecuteUbergraph_BP_InteractableDegradableTechPrePlanning, EntryPoint) == 0x000000, "Member 'BP_InteractableDegradableTechPrePlanning_C_ExecuteUbergraph_BP_InteractableDegradableTechPrePlanning::EntryPoint' has a wrong offset!");
...
struct BP_InteractableDegradableTechPrePlanning_C_BndEvt__BP_InteractableDegradableTechPrePlanning_Interactable_K2Node_ComponentBoundEvent_5_SBZOnInteraction__DelegateSignature final
{
public:
...
// 0x0018 (0x0018 - 0x0000)
struct BP_InteractableDegradableTechPrePlanning_C_BndEvt__BP_InteractableDegradableTech_Interactable_K2Node_ComponentBoundEvent_0_SBZOnInteraction__DelegateSignature final
{
public:
	class USBZBaseInteractableComponent*          Interactable_0;                                    // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class USBZInteractorComponent*                Interactor;                                        // 0x0008(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct BP_InteractableDegradableTechPrePlanning_C_BP_OnChangedToSecondaryType final
{
public:
	bool                                          bDoCosmetics;                                      // 0x0000(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
};
static_assert(alignof(BP_InteractableDegradableTechPrePlanning_C_BP_OnChangedToSecondaryType) == 0x000001, "Wrong alignment on BP_InteractableDegradableTechPrePlanning_C_BP_OnChangedToSecondaryType");
static_assert(sizeof(BP_InteractableDegradableTechPrePlanning_C_BP_OnChangedToSecondaryType) == 0x000001, "Wrong size on BP_InteractableDegradableTechPrePlanning_C_BP_OnChangedToSecondaryType");
static_assert(offsetof(BP_InteractableDegradableTechPrePlanning_C_BP_OnChangedToSecondaryType, bDoCosmetics) == 0x000000, "Member 'BP_InteractableDegradableTechPrePlanning_C_BP_OnChangedToSecondaryType::bDoCosmetics' has a wrong offset!");
