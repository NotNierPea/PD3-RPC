...
static_assert(sizeof(DataRegistrySubsystem_FindCachedItemBP) == 0x000028, "Wrong size on DataRegistrySubsystem_FindCachedItemBP");
...
static_assert(sizeof(DataRegistrySubsystem_GetCachedItemBP) == 0x000028, "Wrong size on DataRegistrySubsystem_GetCachedItemBP");
...
static_assert(offsetof(DataRegistrySubsystem_GetCachedItemBP, ReturnValue) == 0x000020, "Member 'DataRegistrySubsystem_GetCachedItemBP::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(DataRegistrySubsystem_GetCachedItemFromLookupBP) == 0x000048, "Wrong size on DataRegistrySubsystem_GetCachedItemFromLookupBP");
...
static_assert(offsetof(DataRegistrySubsystem_GetCachedItemFromLookupBP, ReturnValue) == 0x000040, "Member 'DataRegistrySubsystem_GetCachedItemFromLookupBP::ReturnValue' has a wrong offset!");
