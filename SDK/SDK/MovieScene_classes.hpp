...
static_assert(sizeof(UMovieSceneEntitySystemLinker) == 0x0004F8, "Wrong size on UMovieSceneEntitySystemLinker");
...
static_assert(sizeof(UMovieSceneCachePreAnimatedStateSystem) == 0x000068, "Wrong size on UMovieSceneCachePreAnimatedStateSystem");
...
static_assert(sizeof(UMovieSceneSequenceTickManager) == 0x0000D8, "Wrong size on UMovieSceneSequenceTickManager");
