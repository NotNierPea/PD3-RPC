...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"BP_Binder_01_C_SmallDestruction_C">();
	}
	static class ABP_Binder_01_C_SmallDestruction_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_Binder_01_C_SmallDestruction_C>();
	}
};
static_assert(alignof(ABP_Binder_01_C_SmallDestruction_C) == 0x000008, "Wrong alignment on ABP_Binder_01_C_SmallDestruction_C");
static_assert(sizeof(ABP_Binder_01_C_SmallDestruction_C) == 0x0002F0, "Wrong size on ABP_Binder_01_C_SmallDestruction_C");
static_assert(offsetof(ABP_Binder_01_C_SmallDestruction_C, UberGraphFrame_BP_Binder_01_C_SmallDestruction_C) == 0x0002E0, "Member 'ABP_Binder_01_C_SmallDestruction_C::UberGraphFrame_BP_Binder_01_C_SmallDestruction_C' has a wrong offset!");
static_assert(offsetof(ABP_Binder_01_C_SmallDestruction_C, SBZCosmeticDestruction) == 0x0002E8, "Member 'ABP_Binder_01_C_SmallDestruction_C::SBZCosmeticDestruction' has a wrong offset!");
