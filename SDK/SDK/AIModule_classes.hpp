...
static_assert(sizeof(UAISense_Sight) == 0x000188, "Wrong size on UAISense_Sight");
...
static_assert(offsetof(UAISense_Sight, PlayerTeamId) == 0x000178, "Member 'UAISense_Sight::PlayerTeamId' has a wrong offset!");
static_assert(offsetof(UAISense_Sight, PlayerImportanceBoost) == 0x00017C, "Member 'UAISense_Sight::PlayerImportanceBoost' has a wrong offset!");
...
static_assert(offsetof(UAISenseConfig_Sight, bUseHorizontalPlanes) == 0x000074, "Member 'UAISenseConfig_Sight::bUseHorizontalPlanes' has a wrong offset!");
static_assert(offsetof(UAISenseConfig_Sight, VerticalVisionOffsetTop) == 0x000078, "Member 'UAISenseConfig_Sight::VerticalVisionOffsetTop' has a wrong offset!");
static_assert(offsetof(UAISenseConfig_Sight, VerticalVisionOffsetBottom) == 0x00007C, "Member 'UAISenseConfig_Sight::VerticalVisionOffsetBottom' has a wrong offset!");
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"BTComposite_Switch">();
	}
...
static_assert(alignof(UBTComposite_Switch) == 0x000008, "Wrong alignment on UBTComposite_Switch");
static_assert(sizeof(UBTComposite_Switch) == 0x000118, "Wrong size on UBTComposite_Switch");
static_assert(offsetof(UBTComposite_Switch, CorrespondancyMap) == 0x000098, "Member 'UBTComposite_Switch::CorrespondancyMap' has a wrong offset!");
static_assert(offsetof(UBTComposite_Switch, BlackboardKey) == 0x0000E8, "Member 'UBTComposite_Switch::BlackboardKey' has a wrong offset!");
...
static_assert(offsetof(UBTTask_MoveTo, RepathDelay) == 0x0000C0, "Member 'UBTTask_MoveTo::RepathDelay' has a wrong offset!");
static_assert(offsetof(UBTTask_MoveTo, InitialDelay) == 0x0000C4, "Member 'UBTTask_MoveTo::InitialDelay' has a wrong offset!");
...
static_assert(sizeof(UBTTask_RotateToFaceBBEntry) == 0x0000E8, "Wrong size on UBTTask_RotateToFaceBBEntry");
...
static_assert(offsetof(UBTTask_RotateToFaceBBEntry, bUseBBPrecision) == 0x0000AC, "Member 'UBTTask_RotateToFaceBBEntry::bUseBBPrecision' has a wrong offset!");
static_assert(offsetof(UBTTask_RotateToFaceBBEntry, PrecisionBBKey) == 0x0000B0, "Member 'UBTTask_RotateToFaceBBEntry::PrecisionBBKey' has a wrong offset!");
...
static_assert(offsetof(UPathFollowingComponent, MovementComp) == 0x000110, "Member 'UPathFollowingComponent::MovementComp' has a wrong offset!");
static_assert(offsetof(UPathFollowingComponent, MyNavData) == 0x000120, "Member 'UPathFollowingComponent::MyNavData' has a wrong offset!");
...
static_assert(sizeof(UCrowdFollowingComponent) == 0x0002C0, "Wrong size on UCrowdFollowingComponent");
static_assert(offsetof(UCrowdFollowingComponent, CrowdAgentMoveDirection) == 0x000290, "Member 'UCrowdFollowingComponent::CrowdAgentMoveDirection' has a wrong offset!");
...
static_assert(sizeof(UCrowdManager) == 0x000148, "Wrong size on UCrowdManager");
...
static_assert(sizeof(AEQSTestingPawn) == 0x000610, "Wrong size on AEQSTestingPawn");
static_assert(offsetof(AEQSTestingPawn, QueryTemplate) == 0x000578, "Member 'AEQSTestingPawn::QueryTemplate' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, QueryParams) == 0x000580, "Member 'AEQSTestingPawn::QueryParams' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, QueryConfig) == 0x000590, "Member 'AEQSTestingPawn::QueryConfig' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, TimeLimitPerStep) == 0x0005A0, "Member 'AEQSTestingPawn::TimeLimitPerStep' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, StepToDebugDraw) == 0x0005A4, "Member 'AEQSTestingPawn::StepToDebugDraw' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, HighlightMode) == 0x0005A8, "Member 'AEQSTestingPawn::HighlightMode' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, QueryingMode) == 0x0005B0, "Member 'AEQSTestingPawn::QueryingMode' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, NavAgentProperties) == 0x0005B8, "Member 'AEQSTestingPawn::NavAgentProperties' has a wrong offset!");
...
static_assert(sizeof(UGridPathFollowingComponent) == 0x0002A8, "Wrong size on UGridPathFollowingComponent");
static_assert(offsetof(UGridPathFollowingComponent, GridManager) == 0x000278, "Member 'UGridPathFollowingComponent::GridManager' has a wrong offset!");
