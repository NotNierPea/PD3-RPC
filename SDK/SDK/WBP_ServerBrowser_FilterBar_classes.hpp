...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"WBP_ServerBrowser_FilterBar_C">();
	}
...
static_assert(alignof(UWBP_ServerBrowser_FilterBar_C) == 0x000008, "Wrong alignment on UWBP_ServerBrowser_FilterBar_C");
static_assert(sizeof(UWBP_ServerBrowser_FilterBar_C) == 0x000300, "Wrong size on UWBP_ServerBrowser_FilterBar_C");
static_assert(offsetof(UWBP_ServerBrowser_FilterBar_C, UberGraphFrame) == 0x000290, "Member 'UWBP_ServerBrowser_FilterBar_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWBP_ServerBrowser_FilterBar_C, Button_FilterOptions) == 0x000298, "Member 'UWBP_ServerBrowser_FilterBar_C::Button_FilterOptions' has a wrong offset!");
static_assert(offsetof(UWBP_ServerBrowser_FilterBar_C, Button_RefreshServers) == 0x0002A0, "Member 'UWBP_ServerBrowser_FilterBar_C::Button_RefreshServers' has a wrong offset!");
static_assert(offsetof(UWBP_ServerBrowser_FilterBar_C, Title_O) == 0x0002A8, "Member 'UWBP_ServerBrowser_FilterBar_C::Title_O' has a wrong offset!");
static_assert(offsetof(UWBP_ServerBrowser_FilterBar_C, TitleBg_I) == 0x0002B0, "Member 'UWBP_ServerBrowser_FilterBar_C::TitleBg_I' has a wrong offset!");
static_assert(offsetof(UWBP_ServerBrowser_FilterBar_C, TitleText_T) == 0x0002B8, "Member 'UWBP_ServerBrowser_FilterBar_C::TitleText_T' has a wrong offset!");
static_assert(offsetof(UWBP_ServerBrowser_FilterBar_C, WBP_UI_Widget_ActionInput) == 0x0002C0, "Member 'UWBP_ServerBrowser_FilterBar_C::WBP_UI_Widget_ActionInput' has a wrong offset!");
static_assert(offsetof(UWBP_ServerBrowser_FilterBar_C, isDifficultyFilterOpen) == 0x0002C8, "Member 'UWBP_ServerBrowser_FilterBar_C::isDifficultyFilterOpen' has a wrong offset!");
static_assert(offsetof(UWBP_ServerBrowser_FilterBar_C, Is_Design_Time) == 0x0002C9, "Member 'UWBP_ServerBrowser_FilterBar_C::Is_Design_Time' has a wrong offset!");
static_assert(offsetof(UWBP_ServerBrowser_FilterBar_C, ParentStackScreen) == 0x0002D0, "Member 'UWBP_ServerBrowser_FilterBar_C::ParentStackScreen' has a wrong offset!");
static_assert(offsetof(UWBP_ServerBrowser_FilterBar_C, ServersRefreshRequested) == 0x0002D8, "Member 'UWBP_ServerBrowser_FilterBar_C::ServersRefreshRequested' has a wrong offset!");
static_assert(offsetof(UWBP_ServerBrowser_FilterBar_C, OnFilterButtonSelected) == 0x0002E8, "Member 'UWBP_ServerBrowser_FilterBar_C::OnFilterButtonSelected' has a wrong offset!");
static_assert(offsetof(UWBP_ServerBrowser_FilterBar_C, ShouldHideTitle) == 0x0002F8, "Member 'UWBP_ServerBrowser_FilterBar_C::ShouldHideTitle' has a wrong offset!");
