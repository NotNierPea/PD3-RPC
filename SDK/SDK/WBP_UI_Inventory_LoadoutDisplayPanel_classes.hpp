...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"WBP_UI_Inventory_LoadoutDisplayPanel_C">();
	}
...
static_assert(alignof(UWBP_UI_Inventory_LoadoutDisplayPanel_C) == 0x000008, "Wrong alignment on UWBP_UI_Inventory_LoadoutDisplayPanel_C");
static_assert(sizeof(UWBP_UI_Inventory_LoadoutDisplayPanel_C) == 0x000378, "Wrong size on UWBP_UI_Inventory_LoadoutDisplayPanel_C");
static_assert(offsetof(UWBP_UI_Inventory_LoadoutDisplayPanel_C, UberGraphFrame) == 0x000328, "Member 'UWBP_UI_Inventory_LoadoutDisplayPanel_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWBP_UI_Inventory_LoadoutDisplayPanel_C, Button_Mask) == 0x000330, "Member 'UWBP_UI_Inventory_LoadoutDisplayPanel_C::Button_Mask' has a wrong offset!");
static_assert(offsetof(UWBP_UI_Inventory_LoadoutDisplayPanel_C, Button_Skills) == 0x000338, "Member 'UWBP_UI_Inventory_LoadoutDisplayPanel_C::Button_Skills' has a wrong offset!");
static_assert(offsetof(UWBP_UI_Inventory_LoadoutDisplayPanel_C, OnButtonFocusChanged) == 0x000340, "Member 'UWBP_UI_Inventory_LoadoutDisplayPanel_C::OnButtonFocusChanged' has a wrong offset!");
static_assert(offsetof(UWBP_UI_Inventory_LoadoutDisplayPanel_C, SkillButtonSelected) == 0x000350, "Member 'UWBP_UI_Inventory_LoadoutDisplayPanel_C::SkillButtonSelected' has a wrong offset!");
static_assert(offsetof(UWBP_UI_Inventory_LoadoutDisplayPanel_C, RT_Skills) == 0x000360, "Member 'UWBP_UI_Inventory_LoadoutDisplayPanel_C::RT_Skills' has a wrong offset!");
static_assert(offsetof(UWBP_UI_Inventory_LoadoutDisplayPanel_C, PreviousSkillButton) == 0x000370, "Member 'UWBP_UI_Inventory_LoadoutDisplayPanel_C::PreviousSkillButton' has a wrong offset!");
