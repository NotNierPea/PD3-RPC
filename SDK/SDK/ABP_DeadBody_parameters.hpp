...
static_assert(alignof(ABP_DeadBody_C_ExecuteUbergraph_ABP_DeadBody) == 0x000004, "Wrong alignment on ABP_DeadBody_C_ExecuteUbergraph_ABP_DeadBody");
static_assert(sizeof(ABP_DeadBody_C_ExecuteUbergraph_ABP_DeadBody) == 0x000004, "Wrong size on ABP_DeadBody_C_ExecuteUbergraph_ABP_DeadBody");
...
static_assert(offsetof(ABP_DeadBody_C_AnimGraph, AnimGraph_0) == 0x000000, "Member 'ABP_DeadBody_C_AnimGraph::AnimGraph_0' has a wrong offset!");
