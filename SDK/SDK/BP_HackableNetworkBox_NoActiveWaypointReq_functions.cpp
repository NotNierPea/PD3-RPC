...
#include "BP_HackableNetworkBox_NoActiveWaypointReq_classes.hpp"
#include "BP_HackableNetworkBox_NoActiveWaypointReq_parameters.hpp"
...
bool UBP_HackableNetworkBox_NoActiveWaypointReq_C::BP_CheckRequirement(const class USBZInteractorComponent* Interactor, struct FSBZInteractReqData* OutData, bool bIsSignalRequired, bool bInIsScreenInteract, bool bIsCasing, bool bIsEncumbered) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_HackableNetworkBox_NoActiveWaypointReq_C", "BP_CheckRequirement");

	Params::BP_HackableNetworkBox_NoActiveWaypointReq_C_BP_CheckRequirement Parms{};
