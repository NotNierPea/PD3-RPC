...
static_assert(offsetof(USignificanceManager, SignificanceManagerClassName) == 0x000110, "Member 'USignificanceManager::SignificanceManagerClassName' has a wrong offset!");
