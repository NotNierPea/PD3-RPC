...
class UGridlyTask_DownloadLocalizedTexts* UGridlyTask_DownloadLocalizedTexts::DownloadLocalizedTexts(const class UObject* WorldContextObject)
{
	static class UFunction* Func = nullptr;
...
class USBZGridlyTask_DownloadGridlyNativeCulture* USBZGridlyTask_DownloadGridlyNativeCulture::DownloadLocalizedTexts(const class UObject* WorldContextObject)
{
	static class UFunction* Func = nullptr;
