...
static_assert(sizeof(WBP_UI_SM_ActionPhaseTransition_C_ExecuteUbergraph_WBP_UI_SM_ActionPhaseTransition) == 0x000058, "Wrong size on WBP_UI_SM_ActionPhaseTransition_C_ExecuteUbergraph_WBP_UI_SM_ActionPhaseTransition");
...
static_assert(offsetof(WBP_UI_SM_ActionPhaseTransition_C_ExecuteUbergraph_WBP_UI_SM_ActionPhaseTransition, CallFunc_PlayAnimationForward_ReturnValue) == 0x000040, "Member 'WBP_UI_SM_ActionPhaseTransition_C_ExecuteUbergraph_WBP_UI_SM_ActionPhaseTransition::CallFunc_PlayAnimationForward_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_UI_SM_ActionPhaseTransition_C_ExecuteUbergraph_WBP_UI_SM_ActionPhaseTransition, CallFunc_PlayAnimationForward_ReturnValue_1) == 0x000048, "Member 'WBP_UI_SM_ActionPhaseTransition_C_ExecuteUbergraph_WBP_UI_SM_ActionPhaseTransition::CallFunc_PlayAnimationForward_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_UI_SM_ActionPhaseTransition_C_ExecuteUbergraph_WBP_UI_SM_ActionPhaseTransition, CallFunc_PlayAnimationForward_ReturnValue_2) == 0x000050, "Member 'WBP_UI_SM_ActionPhaseTransition_C_ExecuteUbergraph_WBP_UI_SM_ActionPhaseTransition::CallFunc_PlayAnimationForward_ReturnValue_2' has a wrong offset!");
...
static_assert(sizeof(WBP_UI_SM_ActionPhaseTransition_C_DisplayTransition) == 0x000010, "Wrong size on WBP_UI_SM_ActionPhaseTransition_C_DisplayTransition");
...
static_assert(offsetof(WBP_UI_SM_ActionPhaseTransition_C_DisplayTransition, CallFunc_PlayAnimationForward_ReturnValue_1) == 0x000008, "Member 'WBP_UI_SM_ActionPhaseTransition_C_DisplayTransition::CallFunc_PlayAnimationForward_ReturnValue_1' has a wrong offset!");
