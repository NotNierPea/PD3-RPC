...
static_assert(alignof(BP_CoffeeMachine_01_B_C_ExecuteUbergraph_BP_CoffeeMachine_01_B) == 0x000008, "Wrong alignment on BP_CoffeeMachine_01_B_C_ExecuteUbergraph_BP_CoffeeMachine_01_B");
static_assert(sizeof(BP_CoffeeMachine_01_B_C_ExecuteUbergraph_BP_CoffeeMachine_01_B) == 0x000050, "Wrong size on BP_CoffeeMachine_01_B_C_ExecuteUbergraph_BP_CoffeeMachine_01_B");
static_assert(offsetof(BP_CoffeeMachine_01_B_C_ExecuteUbergraph_BP_CoffeeMachine_01_B, EntryPoint) == 0x000000, "Member 'BP_CoffeeMachine_01_B_C_ExecuteUbergraph_BP_CoffeeMachine_01_B::EntryPoint' has a wrong offset!");
static_assert(offsetof(BP_CoffeeMachine_01_B_C_ExecuteUbergraph_BP_CoffeeMachine_01_B, CallFunc_IsDedicatedServer_ReturnValue) == 0x000004, "Member 'BP_CoffeeMachine_01_B_C_ExecuteUbergraph_BP_CoffeeMachine_01_B::CallFunc_IsDedicatedServer_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_CoffeeMachine_01_B_C_ExecuteUbergraph_BP_CoffeeMachine_01_B, K2Node_ComponentBoundEvent_Type) == 0x000005, "Member 'BP_CoffeeMachine_01_B_C_ExecuteUbergraph_BP_CoffeeMachine_01_B::K2Node_ComponentBoundEvent_Type' has a wrong offset!");
static_assert(offsetof(BP_CoffeeMachine_01_B_C_ExecuteUbergraph_BP_CoffeeMachine_01_B, K2Node_ComponentBoundEvent_HitContext) == 0x000008, "Member 'BP_CoffeeMachine_01_B_C_ExecuteUbergraph_BP_CoffeeMachine_01_B::K2Node_ComponentBoundEvent_HitContext' has a wrong offset!");
static_assert(offsetof(BP_CoffeeMachine_01_B_C_ExecuteUbergraph_BP_CoffeeMachine_01_B, CallFunc_Conv_VectorToRotator_ReturnValue) == 0x000038, "Member 'BP_CoffeeMachine_01_B_C_ExecuteUbergraph_BP_CoffeeMachine_01_B::CallFunc_Conv_VectorToRotator_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_CoffeeMachine_01_B_C_ExecuteUbergraph_BP_CoffeeMachine_01_B, CallFunc_SpawnSystemAtLocation_ReturnValue) == 0x000048, "Member 'BP_CoffeeMachine_01_B_C_ExecuteUbergraph_BP_CoffeeMachine_01_B::CallFunc_SpawnSystemAtLocation_ReturnValue' has a wrong offset!");
