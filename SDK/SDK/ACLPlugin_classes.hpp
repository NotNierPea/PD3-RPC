...
static_assert(alignof(UAnimationCompressionLibraryDatabase) == 0x000040, "Wrong alignment on UAnimationCompressionLibraryDatabase");
static_assert(sizeof(UAnimationCompressionLibraryDatabase) == 0x000140, "Wrong size on UAnimationCompressionLibraryDatabase");
...
static_assert(sizeof(UAnimBoneCompressionCodec_ACLBase) == 0x000048, "Wrong size on UAnimBoneCompressionCodec_ACLBase");
static_assert(offsetof(UAnimBoneCompressionCodec_ACLBase, bRootBoneOnly) == 0x000040, "Member 'UAnimBoneCompressionCodec_ACLBase::bRootBoneOnly' has a wrong offset!");
...
static_assert(sizeof(UAnimBoneCompressionCodec_ACL) == 0x000050, "Wrong size on UAnimBoneCompressionCodec_ACL");
static_assert(offsetof(UAnimBoneCompressionCodec_ACL, SafetyFallbackCodec) == 0x000048, "Member 'UAnimBoneCompressionCodec_ACL::SafetyFallbackCodec' has a wrong offset!");
...
static_assert(sizeof(UAnimBoneCompressionCodec_ACLCustom) == 0x000048, "Wrong size on UAnimBoneCompressionCodec_ACLCustom");
...
static_assert(offsetof(UAnimBoneCompressionCodec_ACLDatabase, DatabaseAsset) == 0x000048, "Member 'UAnimBoneCompressionCodec_ACLDatabase::DatabaseAsset' has a wrong offset!");
...
static_assert(sizeof(UAnimBoneCompressionCodec_ACLSafe) == 0x000048, "Wrong size on UAnimBoneCompressionCodec_ACLSafe");
