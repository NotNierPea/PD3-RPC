...
static_assert(sizeof(ULiveLinkVirtualSubject) == 0x000168, "Wrong size on ULiveLinkVirtualSubject");
...
static_assert(offsetof(ULiveLinkVirtualSubject, bRebroadcastSubject) == 0x000060, "Member 'ULiveLinkVirtualSubject::bRebroadcastSubject' has a wrong offset!");
