...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"UI_WeaponStatsBlueprint_C">();
	}
...
static_assert(alignof(UUI_WeaponStatsBlueprint_C) == 0x000008, "Wrong alignment on UUI_WeaponStatsBlueprint_C");
static_assert(sizeof(UUI_WeaponStatsBlueprint_C) == 0x000030, "Wrong size on UUI_WeaponStatsBlueprint_C");
