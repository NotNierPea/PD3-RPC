...
static_assert(offsetof(UHoudiniAssetComponent, SubAssetIndex) == 0x00081C, "Member 'UHoudiniAssetComponent::SubAssetIndex' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, AssetCookCount) == 0x000820, "Member 'UHoudiniAssetComponent::AssetCookCount' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bHasBeenLoaded) == 0x000824, "Member 'UHoudiniAssetComponent::bHasBeenLoaded' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bHasBeenDuplicated) == 0x000825, "Member 'UHoudiniAssetComponent::bHasBeenDuplicated' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bPendingDelete) == 0x000826, "Member 'UHoudiniAssetComponent::bPendingDelete' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bRecookRequested) == 0x000827, "Member 'UHoudiniAssetComponent::bRecookRequested' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bRebuildRequested) == 0x000828, "Member 'UHoudiniAssetComponent::bRebuildRequested' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bEnableCooking) == 0x000829, "Member 'UHoudiniAssetComponent::bEnableCooking' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bForceNeedUpdate) == 0x00082A, "Member 'UHoudiniAssetComponent::bForceNeedUpdate' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bLastCookSuccess) == 0x00082B, "Member 'UHoudiniAssetComponent::bLastCookSuccess' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bParameterDefinitionUpdateNeeded) == 0x00082C, "Member 'UHoudiniAssetComponent::bParameterDefinitionUpdateNeeded' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bBlueprintStructureModified) == 0x00082D, "Member 'UHoudiniAssetComponent::bBlueprintStructureModified' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bBlueprintModified) == 0x00082E, "Member 'UHoudiniAssetComponent::bBlueprintModified' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, Parameters) == 0x000830, "Member 'UHoudiniAssetComponent::Parameters' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, Inputs) == 0x000840, "Member 'UHoudiniAssetComponent::Inputs' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, Outputs) == 0x000850, "Member 'UHoudiniAssetComponent::Outputs' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, BakedOutputs) == 0x000860, "Member 'UHoudiniAssetComponent::BakedOutputs' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, UntrackedOutputs) == 0x000870, "Member 'UHoudiniAssetComponent::UntrackedOutputs' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, HandleComponents) == 0x000880, "Member 'UHoudiniAssetComponent::HandleComponents' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bHasComponentTransformChanged) == 0x000890, "Member 'UHoudiniAssetComponent::bHasComponentTransformChanged' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bFullyLoaded) == 0x000891, "Member 'UHoudiniAssetComponent::bFullyLoaded' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, PDGAssetLink) == 0x000898, "Member 'UHoudiniAssetComponent::PDGAssetLink' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, RefineMeshesTimer) == 0x0008A0, "Member 'UHoudiniAssetComponent::RefineMeshesTimer' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bNoProxyMeshNextCookRequested) == 0x0008C0, "Member 'UHoudiniAssetComponent::bNoProxyMeshNextCookRequested' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, InputPresets) == 0x0008C8, "Member 'UHoudiniAssetComponent::InputPresets' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bBakeAfterNextCook) == 0x000918, "Member 'UHoudiniAssetComponent::bBakeAfterNextCook' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, bCachedIsPreview) == 0x000978, "Member 'UHoudiniAssetComponent::bCachedIsPreview' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetComponent, LastTickTime) == 0x000988, "Member 'UHoudiniAssetComponent::LastTickTime' has a wrong offset!");
...
static_assert(sizeof(UHoudiniAssetBlueprintComponent) == 0x000AA0, "Wrong size on UHoudiniAssetBlueprintComponent");
static_assert(offsetof(UHoudiniAssetBlueprintComponent, FauxBPProperty) == 0x0009F0, "Member 'UHoudiniAssetBlueprintComponent::FauxBPProperty' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetBlueprintComponent, bHoudiniAssetChanged) == 0x0009F1, "Member 'UHoudiniAssetBlueprintComponent::bHoudiniAssetChanged' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetBlueprintComponent, bUpdatedFromTemplate) == 0x0009F2, "Member 'UHoudiniAssetBlueprintComponent::bUpdatedFromTemplate' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetBlueprintComponent, bIsInBlueprintEditor) == 0x0009F3, "Member 'UHoudiniAssetBlueprintComponent::bIsInBlueprintEditor' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetBlueprintComponent, bCanDeleteHoudiniNodes) == 0x0009F4, "Member 'UHoudiniAssetBlueprintComponent::bCanDeleteHoudiniNodes' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetBlueprintComponent, bHasRegisteredComponentTemplate) == 0x0009F5, "Member 'UHoudiniAssetBlueprintComponent::bHasRegisteredComponentTemplate' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetBlueprintComponent, CachedOutputNodes) == 0x000A00, "Member 'UHoudiniAssetBlueprintComponent::CachedOutputNodes' has a wrong offset!");
static_assert(offsetof(UHoudiniAssetBlueprintComponent, CachedInputNodes) == 0x000A50, "Member 'UHoudiniAssetBlueprintComponent::CachedInputNodes' has a wrong offset!");
...
static_assert(sizeof(UHoudiniHandleComponent_V1) == 0x0002C0, "Wrong size on UHoudiniHandleComponent_V1");
...
static_assert(sizeof(UHoudiniSplineComponent_V1) == 0x000320, "Wrong size on UHoudiniSplineComponent_V1");
...
static_assert(sizeof(UHoudiniInstancedActorComponent_V1) == 0x000240, "Wrong size on UHoudiniInstancedActorComponent_V1");
...
static_assert(sizeof(UHoudiniMeshSplitInstancerComponent_V1) == 0x000250, "Wrong size on UHoudiniMeshSplitInstancerComponent_V1");
...
static_assert(sizeof(UHoudiniHandleComponent) == 0x000260, "Wrong size on UHoudiniHandleComponent");
static_assert(offsetof(UHoudiniHandleComponent, XformParms) == 0x000228, "Member 'UHoudiniHandleComponent::XformParms' has a wrong offset!");
static_assert(offsetof(UHoudiniHandleComponent, RSTParm) == 0x000238, "Member 'UHoudiniHandleComponent::RSTParm' has a wrong offset!");
static_assert(offsetof(UHoudiniHandleComponent, RotOrderParm) == 0x000240, "Member 'UHoudiniHandleComponent::RotOrderParm' has a wrong offset!");
static_assert(offsetof(UHoudiniHandleComponent, HandleType) == 0x000248, "Member 'UHoudiniHandleComponent::HandleType' has a wrong offset!");
static_assert(offsetof(UHoudiniHandleComponent, HandleName) == 0x000250, "Member 'UHoudiniHandleComponent::HandleName' has a wrong offset!");
...
static_assert(sizeof(UHoudiniInput) == 0x000200, "Wrong size on UHoudiniInput");
...
static_assert(offsetof(UHoudiniInput, bExportLODs) == 0x000094, "Member 'UHoudiniInput::bExportLODs' has a wrong offset!");
static_assert(offsetof(UHoudiniInput, bExportSockets) == 0x000095, "Member 'UHoudiniInput::bExportSockets' has a wrong offset!");
static_assert(offsetof(UHoudiniInput, bExportColliders) == 0x000096, "Member 'UHoudiniInput::bExportColliders' has a wrong offset!");
static_assert(offsetof(UHoudiniInput, bCookOnCurveChanged) == 0x000097, "Member 'UHoudiniInput::bCookOnCurveChanged' has a wrong offset!");
static_assert(offsetof(UHoudiniInput, GeometryInputObjects) == 0x000098, "Member 'UHoudiniInput::GeometryInputObjects' has a wrong offset!");
static_assert(offsetof(UHoudiniInput, bStaticMeshChanged) == 0x0000A8, "Member 'UHoudiniInput::bStaticMeshChanged' has a wrong offset!");
static_assert(offsetof(UHoudiniInput, AssetInputObjects) == 0x0000B0, "Member 'UHoudiniInput::AssetInputObjects' has a wrong offset!");
static_assert(offsetof(UHoudiniInput, bInputAssetConnectedInHoudini) == 0x0000C0, "Member 'UHoudiniInput::bInputAssetConnectedInHoudini' has a wrong offset!");
static_assert(offsetof(UHoudiniInput, CurveInputObjects) == 0x0000C8, "Member 'UHoudiniInput::CurveInputObjects' has a wrong offset!");
static_assert(offsetof(UHoudiniInput, DefaultCurveOffset) == 0x0000D8, "Member 'UHoudiniInput::DefaultCurveOffset' has a wrong offset!");
static_assert(offsetof(UHoudiniInput, bAddRotAndScaleAttributesOnCurves) == 0x0000DC, "Member 'UHoudiniInput::bAddRotAndScaleAttributesOnCurves' has a wrong offset!");
static_assert(offsetof(UHoudiniInput, LandscapeInputObjects) == 0x0000E0, "Member 'UHoudiniInput::LandscapeInputObjects' has a wrong offset!");
static_assert(offsetof(UHoudiniInput, bLandscapeHasExportTypeChanged) == 0x0000F0, "Member 'UHoudiniInput::bLandscapeHasExportTypeChanged' has a wrong offset!");
static_assert(offsetof(UHoudiniInput, WorldInputObjects) == 0x0000F8, "Member 'UHoudiniInput::WorldInputObjects' has a wrong offset!");
static_assert(offsetof(UHoudiniInput, WorldInputBoundSelectorObjects) == 0x000108, "Member 'UHoudiniInput::WorldInputBoundSelectorObjects' has a wrong offset!");
static_assert(offsetof(UHoudiniInput, bIsWorldInputBoundSelector) == 0x000118, "Member 'UHoudiniInput::bIsWorldInputBoundSelector' has a wrong offset!");
static_assert(offsetof(UHoudiniInput, bWorldInputBoundSelectorAutoUpdate) == 0x000119, "Member 'UHoudiniInput::bWorldInputBoundSelectorAutoUpdate' has a wrong offset!");
static_assert(offsetof(UHoudiniInput, UnrealSplineResolution) == 0x00011C, "Member 'UHoudiniInput::UnrealSplineResolution' has a wrong offset!");
static_assert(offsetof(UHoudiniInput, SkeletalInputObjects) == 0x000120, "Member 'UHoudiniInput::SkeletalInputObjects' has a wrong offset!");
static_assert(offsetof(UHoudiniInput, LandscapeSelectedComponents) == 0x000130, "Member 'UHoudiniInput::LandscapeSelectedComponents' has a wrong offset!");
static_assert(offsetof(UHoudiniInput, InputNodesPendingDelete) == 0x000180, "Member 'UHoudiniInput::InputNodesPendingDelete' has a wrong offset!");
static_assert(offsetof(UHoudiniInput, LastInsertedInputs) == 0x0001D0, "Member 'UHoudiniInput::LastInsertedInputs' has a wrong offset!");
static_assert(offsetof(UHoudiniInput, LastUndoDeletedInputs) == 0x0001E0, "Member 'UHoudiniInput::LastUndoDeletedInputs' has a wrong offset!");
static_assert(offsetof(UHoudiniInput, bUpdateInputLandscape) == 0x0001F0, "Member 'UHoudiniInput::bUpdateInputLandscape' has a wrong offset!");
static_assert(offsetof(UHoudiniInput, LandscapeExportType) == 0x0001F1, "Member 'UHoudiniInput::LandscapeExportType' has a wrong offset!");
static_assert(offsetof(UHoudiniInput, bLandscapeExportSelectionOnly) == 0x0001F2, "Member 'UHoudiniInput::bLandscapeExportSelectionOnly' has a wrong offset!");
static_assert(offsetof(UHoudiniInput, bLandscapeAutoSelectComponent) == 0x0001F3, "Member 'UHoudiniInput::bLandscapeAutoSelectComponent' has a wrong offset!");
static_assert(offsetof(UHoudiniInput, bLandscapeExportMaterials) == 0x0001F4, "Member 'UHoudiniInput::bLandscapeExportMaterials' has a wrong offset!");
static_assert(offsetof(UHoudiniInput, bLandscapeExportLighting) == 0x0001F5, "Member 'UHoudiniInput::bLandscapeExportLighting' has a wrong offset!");
static_assert(offsetof(UHoudiniInput, bLandscapeExportNormalizedUVs) == 0x0001F6, "Member 'UHoudiniInput::bLandscapeExportNormalizedUVs' has a wrong offset!");
static_assert(offsetof(UHoudiniInput, bLandscapeExportTileUVs) == 0x0001F7, "Member 'UHoudiniInput::bLandscapeExportTileUVs' has a wrong offset!");
static_assert(offsetof(UHoudiniInput, bCanDeleteHoudiniNodes) == 0x0001F8, "Member 'UHoudiniInput::bCanDeleteHoudiniNodes' has a wrong offset!");
...
static_assert(sizeof(UHoudiniInputObject) == 0x0000C0, "Wrong size on UHoudiniInputObject");
...
static_assert(offsetof(UHoudiniInputObject, bHasChanged) == 0x0000AC, "Member 'UHoudiniInputObject::bHasChanged' has a wrong offset!");
static_assert(offsetof(UHoudiniInputObject, bNeedsToTriggerUpdate) == 0x0000AD, "Member 'UHoudiniInputObject::bNeedsToTriggerUpdate' has a wrong offset!");
static_assert(offsetof(UHoudiniInputObject, bTransformChanged) == 0x0000AE, "Member 'UHoudiniInputObject::bTransformChanged' has a wrong offset!");
static_assert(offsetof(UHoudiniInputObject, bImportAsReference) == 0x0000AF, "Member 'UHoudiniInputObject::bImportAsReference' has a wrong offset!");
static_assert(offsetof(UHoudiniInputObject, bImportAsReferenceRotScaleEnabled) == 0x0000B0, "Member 'UHoudiniInputObject::bImportAsReferenceRotScaleEnabled' has a wrong offset!");
static_assert(offsetof(UHoudiniInputObject, bCanDeleteHoudiniNodes) == 0x0000B1, "Member 'UHoudiniInputObject::bCanDeleteHoudiniNodes' has a wrong offset!");
...
static_assert(sizeof(UHoudiniInputStaticMesh) == 0x0000D0, "Wrong size on UHoudiniInputStaticMesh");
static_assert(offsetof(UHoudiniInputStaticMesh, BlueprintStaticMeshes) == 0x0000B8, "Member 'UHoudiniInputStaticMesh::BlueprintStaticMeshes' has a wrong offset!");
...
static_assert(sizeof(UHoudiniInputSkeletalMesh) == 0x0000C0, "Wrong size on UHoudiniInputSkeletalMesh");
...
static_assert(sizeof(UHoudiniInputSceneComponent) == 0x0000F0, "Wrong size on UHoudiniInputSceneComponent");
static_assert(offsetof(UHoudiniInputSceneComponent, ActorTransform) == 0x0000C0, "Member 'UHoudiniInputSceneComponent::ActorTransform' has a wrong offset!");
...
static_assert(sizeof(UHoudiniInputMeshComponent) == 0x000130, "Wrong size on UHoudiniInputMeshComponent");
static_assert(offsetof(UHoudiniInputMeshComponent, StaticMesh) == 0x0000F0, "Member 'UHoudiniInputMeshComponent::StaticMesh' has a wrong offset!");
static_assert(offsetof(UHoudiniInputMeshComponent, MeshComponentsMaterials) == 0x000120, "Member 'UHoudiniInputMeshComponent::MeshComponentsMaterials' has a wrong offset!");
...
static_assert(sizeof(UHoudiniInputInstancedMeshComponent) == 0x000140, "Wrong size on UHoudiniInputInstancedMeshComponent");
static_assert(offsetof(UHoudiniInputInstancedMeshComponent, InstanceTransforms) == 0x000130, "Member 'UHoudiniInputInstancedMeshComponent::InstanceTransforms' has a wrong offset!");
...
static_assert(sizeof(UHoudiniInputSplineComponent) == 0x000110, "Wrong size on UHoudiniInputSplineComponent");
static_assert(offsetof(UHoudiniInputSplineComponent, NumberOfSplineControlPoints) == 0x0000F0, "Member 'UHoudiniInputSplineComponent::NumberOfSplineControlPoints' has a wrong offset!");
static_assert(offsetof(UHoudiniInputSplineComponent, SplineLength) == 0x0000F4, "Member 'UHoudiniInputSplineComponent::SplineLength' has a wrong offset!");
static_assert(offsetof(UHoudiniInputSplineComponent, SplineResolution) == 0x0000F8, "Member 'UHoudiniInputSplineComponent::SplineResolution' has a wrong offset!");
static_assert(offsetof(UHoudiniInputSplineComponent, SplineClosed) == 0x0000FC, "Member 'UHoudiniInputSplineComponent::SplineClosed' has a wrong offset!");
static_assert(offsetof(UHoudiniInputSplineComponent, SplineControlPoints) == 0x000100, "Member 'UHoudiniInputSplineComponent::SplineControlPoints' has a wrong offset!");
...
static_assert(sizeof(UHoudiniInputHoudiniSplineComponent) == 0x0000D0, "Wrong size on UHoudiniInputHoudiniSplineComponent");
static_assert(offsetof(UHoudiniInputHoudiniSplineComponent, CurveType) == 0x0000B8, "Member 'UHoudiniInputHoudiniSplineComponent::CurveType' has a wrong offset!");
static_assert(offsetof(UHoudiniInputHoudiniSplineComponent, CurveMethod) == 0x0000B9, "Member 'UHoudiniInputHoudiniSplineComponent::CurveMethod' has a wrong offset!");
static_assert(offsetof(UHoudiniInputHoudiniSplineComponent, Reversed) == 0x0000BA, "Member 'UHoudiniInputHoudiniSplineComponent::Reversed' has a wrong offset!");
static_assert(offsetof(UHoudiniInputHoudiniSplineComponent, CachedComponent) == 0x0000C0, "Member 'UHoudiniInputHoudiniSplineComponent::CachedComponent' has a wrong offset!");
...
static_assert(sizeof(UHoudiniInputCameraComponent) == 0x000110, "Wrong size on UHoudiniInputCameraComponent");
static_assert(offsetof(UHoudiniInputCameraComponent, FOV) == 0x0000F0, "Member 'UHoudiniInputCameraComponent::FOV' has a wrong offset!");
static_assert(offsetof(UHoudiniInputCameraComponent, AspectRatio) == 0x0000F4, "Member 'UHoudiniInputCameraComponent::AspectRatio' has a wrong offset!");
static_assert(offsetof(UHoudiniInputCameraComponent, bIsOrthographic) == 0x0000F8, "Member 'UHoudiniInputCameraComponent::bIsOrthographic' has a wrong offset!");
static_assert(offsetof(UHoudiniInputCameraComponent, OrthoWidth) == 0x0000FC, "Member 'UHoudiniInputCameraComponent::OrthoWidth' has a wrong offset!");
static_assert(offsetof(UHoudiniInputCameraComponent, OrthoNearClipPlane) == 0x000100, "Member 'UHoudiniInputCameraComponent::OrthoNearClipPlane' has a wrong offset!");
static_assert(offsetof(UHoudiniInputCameraComponent, OrthoFarClipPlane) == 0x000104, "Member 'UHoudiniInputCameraComponent::OrthoFarClipPlane' has a wrong offset!");
...
static_assert(sizeof(UHoudiniInputHoudiniAsset) == 0x0000C0, "Wrong size on UHoudiniInputHoudiniAsset");
static_assert(offsetof(UHoudiniInputHoudiniAsset, AssetOutputIndex) == 0x0000B8, "Member 'UHoudiniInputHoudiniAsset::AssetOutputIndex' has a wrong offset!");
...
static_assert(sizeof(UHoudiniInputActor) == 0x000120, "Wrong size on UHoudiniInputActor");
static_assert(offsetof(UHoudiniInputActor, ActorComponents) == 0x0000B8, "Member 'UHoudiniInputActor::ActorComponents' has a wrong offset!");
static_assert(offsetof(UHoudiniInputActor, ActorSceneComponents) == 0x0000C8, "Member 'UHoudiniInputActor::ActorSceneComponents' has a wrong offset!");
static_assert(offsetof(UHoudiniInputActor, LastUpdateNumComponentsAdded) == 0x000118, "Member 'UHoudiniInputActor::LastUpdateNumComponentsAdded' has a wrong offset!");
static_assert(offsetof(UHoudiniInputActor, LastUpdateNumComponentsRemoved) == 0x00011C, "Member 'UHoudiniInputActor::LastUpdateNumComponentsRemoved' has a wrong offset!");
...
static_assert(offsetof(UHoudiniInputLandscape, CachedInputLandscapeTraqnsform) == 0x000120, "Member 'UHoudiniInputLandscape::CachedInputLandscapeTraqnsform' has a wrong offset!");
...
static_assert(sizeof(UHoudiniInputBrush) == 0x000140, "Wrong size on UHoudiniInputBrush");
static_assert(offsetof(UHoudiniInputBrush, BrushesInfo) == 0x000120, "Member 'UHoudiniInputBrush::BrushesInfo' has a wrong offset!");
static_assert(offsetof(UHoudiniInputBrush, CombinedModel) == 0x000130, "Member 'UHoudiniInputBrush::CombinedModel' has a wrong offset!");
static_assert(offsetof(UHoudiniInputBrush, bIgnoreInputObject) == 0x000138, "Member 'UHoudiniInputBrush::bIgnoreInputObject' has a wrong offset!");
static_assert(offsetof(UHoudiniInputBrush, CachedInputBrushType) == 0x000139, "Member 'UHoudiniInputBrush::CachedInputBrushType' has a wrong offset!");
...
static_assert(sizeof(UHoudiniInputDataTable) == 0x0000C0, "Wrong size on UHoudiniInputDataTable");
...
static_assert(sizeof(UHoudiniInputFoliageType_InstancedStaticMesh) == 0x0000D0, "Wrong size on UHoudiniInputFoliageType_InstancedStaticMesh");
...
static_assert(sizeof(UHoudiniInstancedActorComponent) == 0x000240, "Wrong size on UHoudiniInstancedActorComponent");
static_assert(offsetof(UHoudiniInstancedActorComponent, InstancedObject) == 0x000228, "Member 'UHoudiniInstancedActorComponent::InstancedObject' has a wrong offset!");
static_assert(offsetof(UHoudiniInstancedActorComponent, InstancedActors) == 0x000230, "Member 'UHoudiniInstancedActorComponent::InstancedActors' has a wrong offset!");
...
static_assert(sizeof(UHoudiniMeshSplitInstancerComponent) == 0x000250, "Wrong size on UHoudiniMeshSplitInstancerComponent");
static_assert(offsetof(UHoudiniMeshSplitInstancerComponent, Instances) == 0x000228, "Member 'UHoudiniMeshSplitInstancerComponent::Instances' has a wrong offset!");
static_assert(offsetof(UHoudiniMeshSplitInstancerComponent, OverrideMaterials) == 0x000238, "Member 'UHoudiniMeshSplitInstancerComponent::OverrideMaterials' has a wrong offset!");
static_assert(offsetof(UHoudiniMeshSplitInstancerComponent, InstancedMesh) == 0x000248, "Member 'UHoudiniMeshSplitInstancerComponent::InstancedMesh' has a wrong offset!");
...
static_assert(offsetof(UHoudiniRuntimeSettings, MarshallingLandscapesUseDefaultUnrealScaling) == 0x000098, "Member 'UHoudiniRuntimeSettings::MarshallingLandscapesUseDefaultUnrealScaling' has a wrong offset!");
static_assert(offsetof(UHoudiniRuntimeSettings, MarshallingLandscapesUseFullResolution) == 0x000099, "Member 'UHoudiniRuntimeSettings::MarshallingLandscapesUseFullResolution' has a wrong offset!");
static_assert(offsetof(UHoudiniRuntimeSettings, MarshallingLandscapesForceMinMaxValues) == 0x00009A, "Member 'UHoudiniRuntimeSettings::MarshallingLandscapesForceMinMaxValues' has a wrong offset!");
...
static_assert(sizeof(UHoudiniSplineComponent) == 0x0004D0, "Wrong size on UHoudiniSplineComponent");
static_assert(offsetof(UHoudiniSplineComponent, CurvePoints) == 0x000230, "Member 'UHoudiniSplineComponent::CurvePoints' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, DisplayPoints) == 0x000240, "Member 'UHoudiniSplineComponent::DisplayPoints' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, DisplayPointIndexDivider) == 0x000250, "Member 'UHoudiniSplineComponent::DisplayPointIndexDivider' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, HoudiniSplineName) == 0x000260, "Member 'UHoudiniSplineComponent::HoudiniSplineName' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, bClosed) == 0x000270, "Member 'UHoudiniSplineComponent::bClosed' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, bReversed) == 0x000271, "Member 'UHoudiniSplineComponent::bReversed' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, bIsHoudiniSplineVisible) == 0x000272, "Member 'UHoudiniSplineComponent::bIsHoudiniSplineVisible' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, CurveType) == 0x000273, "Member 'UHoudiniSplineComponent::CurveType' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, CurveMethod) == 0x000274, "Member 'UHoudiniSplineComponent::CurveMethod' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, bIsOutputCurve) == 0x000275, "Member 'UHoudiniSplineComponent::bIsOutputCurve' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, bCookOnCurveChanged) == 0x000276, "Member 'UHoudiniSplineComponent::bCookOnCurveChanged' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, bHasChanged) == 0x0004B0, "Member 'UHoudiniSplineComponent::bHasChanged' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, bNeedsToTriggerUpdate) == 0x0004B1, "Member 'UHoudiniSplineComponent::bNeedsToTriggerUpdate' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, bIsInputCurve) == 0x0004B2, "Member 'UHoudiniSplineComponent::bIsInputCurve' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, bIsEditableOutputCurve) == 0x0004B3, "Member 'UHoudiniSplineComponent::bIsEditableOutputCurve' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, NodeId) == 0x0004B4, "Member 'UHoudiniSplineComponent::NodeId' has a wrong offset!");
static_assert(offsetof(UHoudiniSplineComponent, PartName) == 0x0004B8, "Member 'UHoudiniSplineComponent::PartName' has a wrong offset!");
