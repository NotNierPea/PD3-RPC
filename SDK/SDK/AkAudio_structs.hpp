...
static_assert(alignof(FAkOutputDeviceID) == 0x000004, "Wrong alignment on FAkOutputDeviceID");
static_assert(sizeof(FAkOutputDeviceID) == 0x000004, "Wrong size on FAkOutputDeviceID");
static_assert(offsetof(FAkOutputDeviceID, IdDevice) == 0x000000, "Member 'FAkOutputDeviceID::IdDevice' has a wrong offset!");
...
static_assert(offsetof(FAkWinGDKAdvancedInitializationSettings, uMaxSystemAudioObjects) == 0x000034, "Member 'FAkWinGDKAdvancedInitializationSettings::uMaxSystemAudioObjects' has a wrong offset!");
