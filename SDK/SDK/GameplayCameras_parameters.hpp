...
static_assert(sizeof(MatineeCameraShake_BlueprintUpdateCameraShake) == 0x000C30, "Wrong size on MatineeCameraShake_BlueprintUpdateCameraShake");
...
static_assert(offsetof(MatineeCameraShake_BlueprintUpdateCameraShake, ModifiedPOV) == 0x000620, "Member 'MatineeCameraShake_BlueprintUpdateCameraShake::ModifiedPOV' has a wrong offset!");
