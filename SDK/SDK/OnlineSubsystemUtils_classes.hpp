...
static_assert(sizeof(UVoipListenerSynthComponent) == 0x000750, "Wrong size on UVoipListenerSynthComponent");
...
static_assert(sizeof(UIpConnection) == 0x001C98, "Wrong size on UIpConnection");
static_assert(offsetof(UIpConnection, SocketErrorDisconnectDelay) == 0x001C48, "Member 'UIpConnection::SocketErrorDisconnectDelay' has a wrong offset!");
...
static_assert(sizeof(UIpNetDriver) == 0x0007F8, "Wrong size on UIpNetDriver");
static_assert(offsetof(UIpNetDriver, MaxPortCountToTry) == 0x00078C, "Member 'UIpNetDriver::MaxPortCountToTry' has a wrong offset!");
...
static_assert(sizeof(UJoinSessionCallbackProxy) == 0x000188, "Wrong size on UJoinSessionCallbackProxy");
...
static_assert(sizeof(AOnlineBeacon) == 0x0002E8, "Wrong size on AOnlineBeacon");
...
static_assert(offsetof(AOnlineBeacon, EditorBeaconConnectionInitialTimeout) == 0x0002B8, "Member 'AOnlineBeacon::EditorBeaconConnectionInitialTimeout' has a wrong offset!");
static_assert(offsetof(AOnlineBeacon, EditorBeaconConnectionTimeout) == 0x0002BC, "Member 'AOnlineBeacon::EditorBeaconConnectionTimeout' has a wrong offset!");
...
static_assert(offsetof(AOnlineBeaconClient, BeaconOwner) == 0x0002E8, "Member 'AOnlineBeaconClient::BeaconOwner' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconClient, BeaconConnection) == 0x0002F0, "Member 'AOnlineBeaconClient::BeaconConnection' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconClient, ConnectionState) == 0x0002F8, "Member 'AOnlineBeaconClient::ConnectionState' has a wrong offset!");
...
static_assert(sizeof(AOnlineBeaconHost) == 0x0003A0, "Wrong size on AOnlineBeaconHost");
static_assert(offsetof(AOnlineBeaconHost, ListenPort) == 0x0002E8, "Member 'AOnlineBeaconHost::ListenPort' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconHost, bReuseAddressAndPort) == 0x0002EC, "Member 'AOnlineBeaconHost::bReuseAddressAndPort' has a wrong offset!");
static_assert(offsetof(AOnlineBeaconHost, ClientActors) == 0x0002F0, "Member 'AOnlineBeaconHost::ClientActors' has a wrong offset!");
...
static_assert(sizeof(UOnlineSessionClient) == 0x0001D0, "Wrong size on UOnlineSessionClient");
static_assert(offsetof(UOnlineSessionClient, bIsFromInvite) == 0x0001C8, "Member 'UOnlineSessionClient::bIsFromInvite' has a wrong offset!");
static_assert(offsetof(UOnlineSessionClient, bHandlingDisconnect) == 0x0001C9, "Member 'UOnlineSessionClient::bHandlingDisconnect' has a wrong offset!");
...
static_assert(offsetof(APartyBeaconClient, DestSessionId) == 0x000378, "Member 'APartyBeaconClient::DestSessionId' has a wrong offset!");
static_assert(offsetof(APartyBeaconClient, PendingReservation) == 0x000388, "Member 'APartyBeaconClient::PendingReservation' has a wrong offset!");
...
static_assert(offsetof(ASpectatorBeaconClient, DestSessionId) == 0x000378, "Member 'ASpectatorBeaconClient::DestSessionId' has a wrong offset!");
static_assert(offsetof(ASpectatorBeaconClient, PendingReservation) == 0x000388, "Member 'ASpectatorBeaconClient::PendingReservation' has a wrong offset!");
...
static_assert(sizeof(ATestBeaconClient) == 0x000348, "Wrong size on ATestBeaconClient");
