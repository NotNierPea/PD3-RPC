...
static_assert(sizeof(UGameMapsSettings) == 0x000128, "Wrong size on UGameMapsSettings");
...
static_assert(offsetof(UGameMapsSettings, ServerDefaultMap) == 0x0000A8, "Member 'UGameMapsSettings::ServerDefaultMap' has a wrong offset!");
...
static_assert(offsetof(UGameMapsSettings, GlobalDefaultServerGameMode) == 0x0000E8, "Member 'UGameMapsSettings::GlobalDefaultServerGameMode' has a wrong offset!");
static_assert(offsetof(UGameMapsSettings, GameModeMapPrefixes) == 0x000108, "Member 'UGameMapsSettings::GameModeMapPrefixes' has a wrong offset!");
static_assert(offsetof(UGameMapsSettings, GameModeClassAliases) == 0x000118, "Member 'UGameMapsSettings::GameModeClassAliases' has a wrong offset!");
