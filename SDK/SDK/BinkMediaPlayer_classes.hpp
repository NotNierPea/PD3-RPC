...
static_assert(offsetof(UBinkMediaPlayer, BinkDestinationUpperLeft) == 0x00007C, "Member 'UBinkMediaPlayer::BinkDestinationUpperLeft' has a wrong offset!");
static_assert(offsetof(UBinkMediaPlayer, BinkDestinationLowerRight) == 0x000084, "Member 'UBinkMediaPlayer::BinkDestinationLowerRight' has a wrong offset!");
static_assert(offsetof(UBinkMediaPlayer, URL) == 0x000090, "Member 'UBinkMediaPlayer::URL' has a wrong offset!");
static_assert(offsetof(UBinkMediaPlayer, BinkBufferMode) == 0x0000A0, "Member 'UBinkMediaPlayer::BinkBufferMode' has a wrong offset!");
static_assert(offsetof(UBinkMediaPlayer, BinkSoundTrack) == 0x0000A1, "Member 'UBinkMediaPlayer::BinkSoundTrack' has a wrong offset!");
static_assert(offsetof(UBinkMediaPlayer, BinkSoundTrackStart) == 0x0000A4, "Member 'UBinkMediaPlayer::BinkSoundTrackStart' has a wrong offset!");
static_assert(offsetof(UBinkMediaPlayer, BinkDrawStyle) == 0x0000A8, "Member 'UBinkMediaPlayer::BinkDrawStyle' has a wrong offset!");
static_assert(offsetof(UBinkMediaPlayer, BinkLayerDepth) == 0x0000AC, "Member 'UBinkMediaPlayer::BinkLayerDepth' has a wrong offset!");
...
static_assert(sizeof(UBinkMoviePlayerSettings) == 0x000050, "Wrong size on UBinkMoviePlayerSettings");
...
static_assert(offsetof(UBinkMoviePlayerSettings, BinkPixelFormat) == 0x000048, "Member 'UBinkMoviePlayerSettings::BinkPixelFormat' has a wrong offset!");
