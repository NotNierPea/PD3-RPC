...
static_assert(sizeof(UFieldSystemComponent) == 0x0005D0, "Wrong size on UFieldSystemComponent");
...
static_assert(offsetof(UFieldSystemComponent, bIsWorldField) == 0x000508, "Member 'UFieldSystemComponent::bIsWorldField' has a wrong offset!");
static_assert(offsetof(UFieldSystemComponent, bIsChaosField) == 0x000509, "Member 'UFieldSystemComponent::bIsChaosField' has a wrong offset!");
static_assert(offsetof(UFieldSystemComponent, SupportedSolvers) == 0x000510, "Member 'UFieldSystemComponent::SupportedSolvers' has a wrong offset!");
static_assert(offsetof(UFieldSystemComponent, ConstructionCommands) == 0x000520, "Member 'UFieldSystemComponent::ConstructionCommands' has a wrong offset!");
static_assert(offsetof(UFieldSystemComponent, BufferCommands) == 0x000550, "Member 'UFieldSystemComponent::BufferCommands' has a wrong offset!");
...
static_assert(sizeof(UFieldSystemMetaDataFilter) == 0x0000C8, "Wrong size on UFieldSystemMetaDataFilter");
static_assert(offsetof(UFieldSystemMetaDataFilter, FilterType) == 0x0000C0, "Member 'UFieldSystemMetaDataFilter::FilterType' has a wrong offset!");
...
static_assert(offsetof(UWaveScalar, Magnitude) == 0x0000C0, "Member 'UWaveScalar::Magnitude' has a wrong offset!");
static_assert(offsetof(UWaveScalar, Position) == 0x0000C4, "Member 'UWaveScalar::Position' has a wrong offset!");
