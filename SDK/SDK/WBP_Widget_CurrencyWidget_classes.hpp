...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"WBP_Widget_CurrencyWidget_C">();
	}
...
static_assert(alignof(UWBP_Widget_CurrencyWidget_C) == 0x000008, "Wrong alignment on UWBP_Widget_CurrencyWidget_C");
static_assert(sizeof(UWBP_Widget_CurrencyWidget_C) == 0x000378, "Wrong size on UWBP_Widget_CurrencyWidget_C");
static_assert(offsetof(UWBP_Widget_CurrencyWidget_C, UberGraphFrame) == 0x0002A8, "Member 'UWBP_Widget_CurrencyWidget_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWBP_Widget_CurrencyWidget_C, CashIcon) == 0x0002B0, "Member 'UWBP_Widget_CurrencyWidget_C::CashIcon' has a wrong offset!");
static_assert(offsetof(UWBP_Widget_CurrencyWidget_C, CreditIcon) == 0x0002B8, "Member 'UWBP_Widget_CurrencyWidget_C::CreditIcon' has a wrong offset!");
static_assert(offsetof(UWBP_Widget_CurrencyWidget_C, GoldIcon) == 0x0002C0, "Member 'UWBP_Widget_CurrencyWidget_C::GoldIcon' has a wrong offset!");
static_assert(offsetof(UWBP_Widget_CurrencyWidget_C, IconSwitcher) == 0x0002C8, "Member 'UWBP_Widget_CurrencyWidget_C::IconSwitcher' has a wrong offset!");
static_assert(offsetof(UWBP_Widget_CurrencyWidget_C, Text_CurrencyAmount) == 0x0002D0, "Member 'UWBP_Widget_CurrencyWidget_C::Text_CurrencyAmount' has a wrong offset!");
static_assert(offsetof(UWBP_Widget_CurrencyWidget_C, WidgetFont) == 0x0002D8, "Member 'UWBP_Widget_CurrencyWidget_C::WidgetFont' has a wrong offset!");
static_assert(offsetof(UWBP_Widget_CurrencyWidget_C, WidgetColor) == 0x000338, "Member 'UWBP_Widget_CurrencyWidget_C::WidgetColor' has a wrong offset!");
static_assert(offsetof(UWBP_Widget_CurrencyWidget_C, EditorValueT) == 0x000360, "Member 'UWBP_Widget_CurrencyWidget_C::EditorValueT' has a wrong offset!");
