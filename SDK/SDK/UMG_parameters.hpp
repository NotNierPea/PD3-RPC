...
static_assert(alignof(UserWidget_GetAnimationLength) == 0x000008, "Wrong alignment on UserWidget_GetAnimationLength");
static_assert(sizeof(UserWidget_GetAnimationLength) == 0x000010, "Wrong size on UserWidget_GetAnimationLength");
static_assert(offsetof(UserWidget_GetAnimationLength, InAnimation) == 0x000000, "Member 'UserWidget_GetAnimationLength::InAnimation' has a wrong offset!");
static_assert(offsetof(UserWidget_GetAnimationLength, ReturnValue) == 0x000008, "Member 'UserWidget_GetAnimationLength::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(MultiLineEditableText_SetWidgetStyle) == 0x000290, "Wrong size on MultiLineEditableText_SetWidgetStyle");
...
static_assert(sizeof(MultiLineEditableTextBox_SetTextStyle) == 0x000290, "Wrong size on MultiLineEditableTextBox_SetTextStyle");
...
static_assert(sizeof(RichTextBlock_SetDefaultTextStyle) == 0x000290, "Wrong size on RichTextBlock_SetDefaultTextStyle");
...
static_assert(alignof(TextBlock_SetTextCasing) == 0x000001, "Wrong alignment on TextBlock_SetTextCasing");
static_assert(sizeof(TextBlock_SetTextCasing) == 0x000001, "Wrong size on TextBlock_SetTextCasing");
static_assert(offsetof(TextBlock_SetTextCasing, InCasing) == 0x000000, "Member 'TextBlock_SetTextCasing::InCasing' has a wrong offset!");
