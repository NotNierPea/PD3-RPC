...
static_assert(offsetof(FAnimNode_LiveLinkPose, InputPose) == 0x000020, "Member 'FAnimNode_LiveLinkPose::InputPose' has a wrong offset!");
static_assert(offsetof(FAnimNode_LiveLinkPose, LiveLinkSubjectName) == 0x000030, "Member 'FAnimNode_LiveLinkPose::LiveLinkSubjectName' has a wrong offset!");
static_assert(offsetof(FAnimNode_LiveLinkPose, RetargetAsset) == 0x000040, "Member 'FAnimNode_LiveLinkPose::RetargetAsset' has a wrong offset!");
static_assert(offsetof(FAnimNode_LiveLinkPose, CurrentRetargetAsset) == 0x000048, "Member 'FAnimNode_LiveLinkPose::CurrentRetargetAsset' has a wrong offset!");
...
static_assert(sizeof(FLiveLinkInstanceProxy) == 0x0007E0, "Wrong size on FLiveLinkInstanceProxy");
