...
static_assert(offsetof(FLevelSequenceAnimSequenceLinkItem, bExportCurves) == 0x000031, "Member 'FLevelSequenceAnimSequenceLinkItem::bExportCurves' has a wrong offset!");
static_assert(offsetof(FLevelSequenceAnimSequenceLinkItem, bRecordInWorldSpace) == 0x000032, "Member 'FLevelSequenceAnimSequenceLinkItem::bRecordInWorldSpace' has a wrong offset!");
