...
static_assert(offsetof(FClassReplicationInfo, DistancePriorityScale) == 0x000004, "Member 'FClassReplicationInfo::DistancePriorityScale' has a wrong offset!");
static_assert(offsetof(FClassReplicationInfo, StarvationPriorityScale) == 0x000008, "Member 'FClassReplicationInfo::StarvationPriorityScale' has a wrong offset!");
static_assert(offsetof(FClassReplicationInfo, AccumulatedNetPriorityBias) == 0x00000C, "Member 'FClassReplicationInfo::AccumulatedNetPriorityBias' has a wrong offset!");
static_assert(offsetof(FClassReplicationInfo, ReplicationPeriodFrame) == 0x000010, "Member 'FClassReplicationInfo::ReplicationPeriodFrame' has a wrong offset!");
static_assert(offsetof(FClassReplicationInfo, FastPath_ReplicationPeriodFrame) == 0x000012, "Member 'FClassReplicationInfo::FastPath_ReplicationPeriodFrame' has a wrong offset!");
static_assert(offsetof(FClassReplicationInfo, ActorChannelFrameTimeout) == 0x000014, "Member 'FClassReplicationInfo::ActorChannelFrameTimeout' has a wrong offset!");
