...
static_assert(offsetof(FAssetBundleEntry, BundleAssets) == 0x000010, "Member 'FAssetBundleEntry::BundleAssets' has a wrong offset!");
...
static_assert(sizeof(FAssetData) == 0x000078, "Wrong size on FAssetData");
