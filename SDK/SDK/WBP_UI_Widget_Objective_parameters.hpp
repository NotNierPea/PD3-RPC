...
public:
	...
	class ASBZObjective*                          K2Node_Event_ObjectiveActivated;                   // 0x0010(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	ESBZTickingLootType                           K2Node_Event_InTickingLootType;                    // 0x0040(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_41[0x7];                                       // 0x0041(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class ASBZObjective*                          K2Node_Event_ObjectiveInit;                        // 0x0048(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_Event_bIsSubObjective;                      // 0x0050(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(offsetof(WBP_UI_Widget_Objective_C_ExecuteUbergraph_WBP_UI_Widget_Objective, K2Node_Event_IsDesignTime) == 0x000004, "Member 'WBP_UI_Widget_Objective_C_ExecuteUbergraph_WBP_UI_Widget_Objective::K2Node_Event_IsDesignTime' has a wrong offset!");
static_assert(offsetof(WBP_UI_Widget_Objective_C_ExecuteUbergraph_WBP_UI_Widget_Objective, CallFunc_GetDynamicMaterial_ReturnValue) == 0x000008, "Member 'WBP_UI_Widget_Objective_C_ExecuteUbergraph_WBP_UI_Widget_Objective::CallFunc_GetDynamicMaterial_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_UI_Widget_Objective_C_ExecuteUbergraph_WBP_UI_Widget_Objective, K2Node_Event_ObjectiveActivated) == 0x000010, "Member 'WBP_UI_Widget_Objective_C_ExecuteUbergraph_WBP_UI_Widget_Objective::K2Node_Event_ObjectiveActivated' has a wrong offset!");
static_assert(offsetof(WBP_UI_Widget_Objective_C_ExecuteUbergraph_WBP_UI_Widget_Objective, K2Node_Event_Animation) == 0x000018, "Member 'WBP_UI_Widget_Objective_C_ExecuteUbergraph_WBP_UI_Widget_Objective::K2Node_Event_Animation' has a wrong offset!");
static_assert(offsetof(WBP_UI_Widget_Objective_C_ExecuteUbergraph_WBP_UI_Widget_Objective, CallFunc_PlayAnimationForward_ReturnValue) == 0x000020, "Member 'WBP_UI_Widget_Objective_C_ExecuteUbergraph_WBP_UI_Widget_Objective::CallFunc_PlayAnimationForward_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_UI_Widget_Objective_C_ExecuteUbergraph_WBP_UI_Widget_Objective, CallFunc_PlayAnimationReverse_ReturnValue) == 0x000028, "Member 'WBP_UI_Widget_Objective_C_ExecuteUbergraph_WBP_UI_Widget_Objective::CallFunc_PlayAnimationReverse_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_UI_Widget_Objective_C_ExecuteUbergraph_WBP_UI_Widget_Objective, CallFunc_IsAnimationPlaying_ReturnValue) == 0x000030, "Member 'WBP_UI_Widget_Objective_C_ExecuteUbergraph_WBP_UI_Widget_Objective::CallFunc_IsAnimationPlaying_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_UI_Widget_Objective_C_ExecuteUbergraph_WBP_UI_Widget_Objective, CallFunc_PlayAnimationReverse_ReturnValue_1) == 0x000038, "Member 'WBP_UI_Widget_Objective_C_ExecuteUbergraph_WBP_UI_Widget_Objective::CallFunc_PlayAnimationReverse_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_UI_Widget_Objective_C_ExecuteUbergraph_WBP_UI_Widget_Objective, K2Node_Event_InTickingLootType) == 0x000040, "Member 'WBP_UI_Widget_Objective_C_ExecuteUbergraph_WBP_UI_Widget_Objective::K2Node_Event_InTickingLootType' has a wrong offset!");
static_assert(offsetof(WBP_UI_Widget_Objective_C_ExecuteUbergraph_WBP_UI_Widget_Objective, K2Node_Event_ObjectiveInit) == 0x000048, "Member 'WBP_UI_Widget_Objective_C_ExecuteUbergraph_WBP_UI_Widget_Objective::K2Node_Event_ObjectiveInit' has a wrong offset!");
static_assert(offsetof(WBP_UI_Widget_Objective_C_ExecuteUbergraph_WBP_UI_Widget_Objective, K2Node_Event_bIsSubObjective) == 0x000050, "Member 'WBP_UI_Widget_Objective_C_ExecuteUbergraph_WBP_UI_Widget_Objective::K2Node_Event_bIsSubObjective' has a wrong offset!");
static_assert(offsetof(WBP_UI_Widget_Objective_C_ExecuteUbergraph_WBP_UI_Widget_Objective, K2Node_SwitchEnum_CmpSuccess) == 0x000051, "Member 'WBP_UI_Widget_Objective_C_ExecuteUbergraph_WBP_UI_Widget_Objective::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
...
static_assert(offsetof(WBP_UI_Widget_Objective_C_ObjectiveActivated, Param_ObjectiveActivated_0) == 0x000000, "Member 'WBP_UI_Widget_Objective_C_ObjectiveActivated::Param_ObjectiveActivated_0' has a wrong offset!");
...
public:
	...
	bool                                          CallFunc_IsAnimationPlaying_ReturnValue_2;         // 0x0020(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
static_assert(sizeof(WBP_UI_Widget_Objective_C_UpdateTickingLootType) == 0x000028, "Wrong size on WBP_UI_Widget_Objective_C_UpdateTickingLootType");
...
static_assert(offsetof(WBP_UI_Widget_Objective_C_UpdateTickingLootType, CallFunc_IsAnimationPlaying_ReturnValue) == 0x000010, "Member 'WBP_UI_Widget_Objective_C_UpdateTickingLootType::CallFunc_IsAnimationPlaying_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_UI_Widget_Objective_C_UpdateTickingLootType, CallFunc_IsAnimationPlaying_ReturnValue_1) == 0x000011, "Member 'WBP_UI_Widget_Objective_C_UpdateTickingLootType::CallFunc_IsAnimationPlaying_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_UI_Widget_Objective_C_UpdateTickingLootType, CallFunc_PlayAnimation_ReturnValue_1) == 0x000018, "Member 'WBP_UI_Widget_Objective_C_UpdateTickingLootType::CallFunc_PlayAnimation_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_UI_Widget_Objective_C_UpdateTickingLootType, CallFunc_IsAnimationPlaying_ReturnValue_2) == 0x000020, "Member 'WBP_UI_Widget_Objective_C_UpdateTickingLootType::CallFunc_IsAnimationPlaying_ReturnValue_2' has a wrong offset!");
