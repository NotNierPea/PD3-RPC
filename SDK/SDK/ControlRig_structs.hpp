...
static_assert(sizeof(FAnimNode_ControlRigBase) == 0x000180, "Wrong size on FAnimNode_ControlRigBase");
static_assert(offsetof(FAnimNode_ControlRigBase, Source) == 0x000068, "Member 'FAnimNode_ControlRigBase::Source' has a wrong offset!");
static_assert(offsetof(FAnimNode_ControlRigBase, ControlRigBoneMapping) == 0x000078, "Member 'FAnimNode_ControlRigBase::ControlRigBoneMapping' has a wrong offset!");
static_assert(offsetof(FAnimNode_ControlRigBase, ControlRigCurveMapping) == 0x0000C8, "Member 'FAnimNode_ControlRigBase::ControlRigCurveMapping' has a wrong offset!");
static_assert(offsetof(FAnimNode_ControlRigBase, InputToCurveMappingUIDs) == 0x000118, "Member 'FAnimNode_ControlRigBase::InputToCurveMappingUIDs' has a wrong offset!");
static_assert(offsetof(FAnimNode_ControlRigBase, NodeMappingContainer) == 0x000168, "Member 'FAnimNode_ControlRigBase::NodeMappingContainer' has a wrong offset!");
static_assert(offsetof(FAnimNode_ControlRigBase, InputSettings) == 0x000170, "Member 'FAnimNode_ControlRigBase::InputSettings' has a wrong offset!");
static_assert(offsetof(FAnimNode_ControlRigBase, OutputSettings) == 0x000172, "Member 'FAnimNode_ControlRigBase::OutputSettings' has a wrong offset!");
static_assert(offsetof(FAnimNode_ControlRigBase, bExecute) == 0x000174, "Member 'FAnimNode_ControlRigBase::bExecute' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_ControlRig) == 0x000380, "Wrong size on FAnimNode_ControlRig");
static_assert(offsetof(FAnimNode_ControlRig, ControlRigClass) == 0x000180, "Member 'FAnimNode_ControlRig::ControlRigClass' has a wrong offset!");
static_assert(offsetof(FAnimNode_ControlRig, ControlRig) == 0x000188, "Member 'FAnimNode_ControlRig::ControlRig' has a wrong offset!");
static_assert(offsetof(FAnimNode_ControlRig, Alpha) == 0x000190, "Member 'FAnimNode_ControlRig::Alpha' has a wrong offset!");
static_assert(offsetof(FAnimNode_ControlRig, AlphaInputType) == 0x000194, "Member 'FAnimNode_ControlRig::AlphaInputType' has a wrong offset!");
static_assert(offsetof(FAnimNode_ControlRig, AlphaScaleBias) == 0x000198, "Member 'FAnimNode_ControlRig::AlphaScaleBias' has a wrong offset!");
static_assert(offsetof(FAnimNode_ControlRig, AlphaBoolBlend) == 0x0001A0, "Member 'FAnimNode_ControlRig::AlphaBoolBlend' has a wrong offset!");
static_assert(offsetof(FAnimNode_ControlRig, AlphaCurveName) == 0x0001E8, "Member 'FAnimNode_ControlRig::AlphaCurveName' has a wrong offset!");
static_assert(offsetof(FAnimNode_ControlRig, AlphaScaleBiasClamp) == 0x0001F4, "Member 'FAnimNode_ControlRig::AlphaScaleBiasClamp' has a wrong offset!");
static_assert(offsetof(FAnimNode_ControlRig, InputMapping) == 0x000228, "Member 'FAnimNode_ControlRig::InputMapping' has a wrong offset!");
static_assert(offsetof(FAnimNode_ControlRig, OutputMapping) == 0x000278, "Member 'FAnimNode_ControlRig::OutputMapping' has a wrong offset!");
static_assert(offsetof(FAnimNode_ControlRig, LODThreshold) == 0x000378, "Member 'FAnimNode_ControlRig::LODThreshold' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_ControlRig_ExternalSource, ControlRig) == 0x000180, "Member 'FAnimNode_ControlRig_ExternalSource::ControlRig' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_ControlRigInputPose) == 0x000040, "Wrong size on FAnimNode_ControlRigInputPose");
static_assert(offsetof(FAnimNode_ControlRigInputPose, InputPose) == 0x000020, "Member 'FAnimNode_ControlRigInputPose::InputPose' has a wrong offset!");
...
static_assert(sizeof(FControlRigSequencerAnimInstanceProxy) == 0x000DE0, "Wrong size on FControlRigSequencerAnimInstanceProxy");
