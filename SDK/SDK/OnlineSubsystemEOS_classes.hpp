...
static_assert(sizeof(UNetConnectionEOS) == 0x001CA0, "Wrong size on UNetConnectionEOS");
...
static_assert(sizeof(UNetDriverEOS) == 0x000800, "Wrong size on UNetDriverEOS");
static_assert(offsetof(UNetDriverEOS, bIsPassthrough) == 0x0007F8, "Member 'UNetDriverEOS::bIsPassthrough' has a wrong offset!");
static_assert(offsetof(UNetDriverEOS, bIsUsingP2PSockets) == 0x0007F9, "Member 'UNetDriverEOS::bIsUsingP2PSockets' has a wrong offset!");
