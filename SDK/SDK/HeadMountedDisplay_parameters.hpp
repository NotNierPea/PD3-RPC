...
static_assert(sizeof(HeadMountedDisplayFunctionLibrary_BreakKey) == 0x000060, "Wrong size on HeadMountedDisplayFunctionLibrary_BreakKey");
...
static_assert(offsetof(HeadMountedDisplayFunctionLibrary_BreakKey, InteractionProfile) == 0x000020, "Member 'HeadMountedDisplayFunctionLibrary_BreakKey::InteractionProfile' has a wrong offset!");
static_assert(offsetof(HeadMountedDisplayFunctionLibrary_BreakKey, Hand) == 0x000030, "Member 'HeadMountedDisplayFunctionLibrary_BreakKey::Hand' has a wrong offset!");
static_assert(offsetof(HeadMountedDisplayFunctionLibrary_BreakKey, MotionSource) == 0x000034, "Member 'HeadMountedDisplayFunctionLibrary_BreakKey::MotionSource' has a wrong offset!");
static_assert(offsetof(HeadMountedDisplayFunctionLibrary_BreakKey, Indentifier) == 0x000040, "Member 'HeadMountedDisplayFunctionLibrary_BreakKey::Indentifier' has a wrong offset!");
static_assert(offsetof(HeadMountedDisplayFunctionLibrary_BreakKey, Component) == 0x000050, "Member 'HeadMountedDisplayFunctionLibrary_BreakKey::Component' has a wrong offset!");
