...
static_assert(sizeof(UDynamicClass) == 0x0002D0, "Wrong size on UDynamicClass");
...
static_assert(sizeof(ULinkerPlaceholderClass) == 0x000408, "Wrong size on ULinkerPlaceholderClass");
