...
static_assert(sizeof(UReplicationGraph) == 0x0004E0, "Wrong size on UReplicationGraph");
...
static_assert(offsetof(UReplicationGraph, GlobalGraphNodes) == 0x0000A0, "Member 'UReplicationGraph::GlobalGraphNodes' has a wrong offset!");
static_assert(offsetof(UReplicationGraph, PrepareForReplicationNodes) == 0x0000B0, "Member 'UReplicationGraph::PrepareForReplicationNodes' has a wrong offset!");
static_assert(offsetof(UReplicationGraph, RpcAllowedBeforeGamestateSynched) == 0x0004B0, "Member 'UReplicationGraph::RpcAllowedBeforeGamestateSynched' has a wrong offset!");
...
static_assert(sizeof(UBasicReplicationGraph) == 0x000510, "Wrong size on UBasicReplicationGraph");
static_assert(offsetof(UBasicReplicationGraph, GridNode) == 0x0004E0, "Member 'UBasicReplicationGraph::GridNode' has a wrong offset!");
static_assert(offsetof(UBasicReplicationGraph, AlwaysRelevantNode) == 0x0004E8, "Member 'UBasicReplicationGraph::AlwaysRelevantNode' has a wrong offset!");
static_assert(offsetof(UBasicReplicationGraph, AlwaysRelevantForConnectionList) == 0x0004F0, "Member 'UBasicReplicationGraph::AlwaysRelevantForConnectionList' has a wrong offset!");
static_assert(offsetof(UBasicReplicationGraph, ActorsWithoutNetConnection) == 0x000500, "Member 'UBasicReplicationGraph::ActorsWithoutNetConnection' has a wrong offset!");
...
static_assert(sizeof(UReplicationGraphNode_GridSpatialization2D) == 0x000240, "Wrong size on UReplicationGraphNode_GridSpatialization2D");
...
static_assert(sizeof(UReplicationGraphNode_AlwaysRelevant_ForConnection) == 0x000118, "Wrong size on UReplicationGraphNode_AlwaysRelevant_ForConnection");
...
static_assert(offsetof(UNetReplicationGraphConnection, DebugActor) == 0x000180, "Member 'UNetReplicationGraphConnection::DebugActor' has a wrong offset!");
static_assert(offsetof(UNetReplicationGraphConnection, LastGatherLocations) == 0x000198, "Member 'UNetReplicationGraphConnection::LastGatherLocations' has a wrong offset!");
static_assert(offsetof(UNetReplicationGraphConnection, ConnectionGraphNodes) == 0x0001B0, "Member 'UNetReplicationGraphConnection::ConnectionGraphNodes' has a wrong offset!");
static_assert(offsetof(UNetReplicationGraphConnection, TearOffNode) == 0x0001C0, "Member 'UNetReplicationGraphConnection::TearOffNode' has a wrong offset!");
