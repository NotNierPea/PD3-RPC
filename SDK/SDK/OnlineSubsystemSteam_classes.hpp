...
static_assert(sizeof(USteamNetConnection) == 0x001CA0, "Wrong size on USteamNetConnection");
static_assert(offsetof(USteamNetConnection, bIsPassthrough) == 0x001C98, "Member 'USteamNetConnection::bIsPassthrough' has a wrong offset!");
...
static_assert(sizeof(USteamNetDriver) == 0x000800, "Wrong size on USteamNetDriver");
