...
static_assert(alignof(BP_Chus_FlammableLiquid_C_ExecuteUbergraph_BP_Chus_FlammableLiquid) == 0x000008, "Wrong alignment on BP_Chus_FlammableLiquid_C_ExecuteUbergraph_BP_Chus_FlammableLiquid");
static_assert(sizeof(BP_Chus_FlammableLiquid_C_ExecuteUbergraph_BP_Chus_FlammableLiquid) == 0x000020, "Wrong size on BP_Chus_FlammableLiquid_C_ExecuteUbergraph_BP_Chus_FlammableLiquid");
static_assert(offsetof(BP_Chus_FlammableLiquid_C_ExecuteUbergraph_BP_Chus_FlammableLiquid, EntryPoint) == 0x000000, "Member 'BP_Chus_FlammableLiquid_C_ExecuteUbergraph_BP_Chus_FlammableLiquid::EntryPoint' has a wrong offset!");
static_assert(offsetof(BP_Chus_FlammableLiquid_C_ExecuteUbergraph_BP_Chus_FlammableLiquid, K2Node_Event_bStateToChangeTo) == 0x000004, "Member 'BP_Chus_FlammableLiquid_C_ExecuteUbergraph_BP_Chus_FlammableLiquid::K2Node_Event_bStateToChangeTo' has a wrong offset!");
static_assert(offsetof(BP_Chus_FlammableLiquid_C_ExecuteUbergraph_BP_Chus_FlammableLiquid, K2Node_Event_bDoCosmetics) == 0x000005, "Member 'BP_Chus_FlammableLiquid_C_ExecuteUbergraph_BP_Chus_FlammableLiquid::K2Node_Event_bDoCosmetics' has a wrong offset!");
static_assert(offsetof(BP_Chus_FlammableLiquid_C_ExecuteUbergraph_BP_Chus_FlammableLiquid, K2Node_ComponentBoundEvent_Interactable) == 0x000008, "Member 'BP_Chus_FlammableLiquid_C_ExecuteUbergraph_BP_Chus_FlammableLiquid::K2Node_ComponentBoundEvent_Interactable' has a wrong offset!");
static_assert(offsetof(BP_Chus_FlammableLiquid_C_ExecuteUbergraph_BP_Chus_FlammableLiquid, K2Node_ComponentBoundEvent_Interactor) == 0x000010, "Member 'BP_Chus_FlammableLiquid_C_ExecuteUbergraph_BP_Chus_FlammableLiquid::K2Node_ComponentBoundEvent_Interactor' has a wrong offset!");
static_assert(offsetof(BP_Chus_FlammableLiquid_C_ExecuteUbergraph_BP_Chus_FlammableLiquid, K2Node_ComponentBoundEvent_bIsLocallyControlledInteractor) == 0x000018, "Member 'BP_Chus_FlammableLiquid_C_ExecuteUbergraph_BP_Chus_FlammableLiquid::K2Node_ComponentBoundEvent_bIsLocallyControlledInteractor' has a wrong offset!");
...
static_assert(alignof(BP_Chus_FlammableLiquid_C_OnStateChanged) == 0x000001, "Wrong alignment on BP_Chus_FlammableLiquid_C_OnStateChanged");
...
static_assert(offsetof(BP_Chus_FlammableLiquid_C_OnStateChanged, bStateToChangeTo) == 0x000000, "Member 'BP_Chus_FlammableLiquid_C_OnStateChanged::bStateToChangeTo' has a wrong offset!");
static_assert(offsetof(BP_Chus_FlammableLiquid_C_OnStateChanged, bDoCosmetics) == 0x000001, "Member 'BP_Chus_FlammableLiquid_C_OnStateChanged::bDoCosmetics' has a wrong offset!");
