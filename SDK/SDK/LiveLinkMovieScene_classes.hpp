...
static_assert(offsetof(UMovieSceneLiveLinkSection, TemplateToPush) == 0x000170, "Member 'UMovieSceneLiveLinkSection::TemplateToPush' has a wrong offset!");
static_assert(offsetof(UMovieSceneLiveLinkSection, RefSkeleton) == 0x000200, "Member 'UMovieSceneLiveLinkSection::RefSkeleton' has a wrong offset!");
static_assert(offsetof(UMovieSceneLiveLinkSection, CurveNames) == 0x000220, "Member 'UMovieSceneLiveLinkSection::CurveNames' has a wrong offset!");
static_assert(offsetof(UMovieSceneLiveLinkSection, PropertyFloatChannels) == 0x000230, "Member 'UMovieSceneLiveLinkSection::PropertyFloatChannels' has a wrong offset!");
...
static_assert(offsetof(UMovieSceneLiveLinkTrack, TrackRole) == 0x0000D8, "Member 'UMovieSceneLiveLinkTrack::TrackRole' has a wrong offset!");
