...
// Function BP_ReplicatedBinaryActorPoisonBottle.BP_ReplicatedBinaryActorPoisonBottle_C.ExecuteUbergraph_BP_ReplicatedBinaryActorPoisonBottle
// 0x0020 (0x0020 - 0x0000)
struct BP_ReplicatedBinaryActorPoisonBottle_C_ExecuteUbergraph_BP_ReplicatedBinaryActorPoisonBottle final
{
public:
	...
	bool                                          K2Node_CustomEvent_Emabled;                        // 0x0019(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
static_assert(alignof(BP_ReplicatedBinaryActorPoisonBottle_C_ExecuteUbergraph_BP_ReplicatedBinaryActorPoisonBottle) == 0x000008, "Wrong alignment on BP_ReplicatedBinaryActorPoisonBottle_C_ExecuteUbergraph_BP_ReplicatedBinaryActorPoisonBottle");
...
static_assert(offsetof(BP_ReplicatedBinaryActorPoisonBottle_C_ExecuteUbergraph_BP_ReplicatedBinaryActorPoisonBottle, EntryPoint) == 0x000000, "Member 'BP_ReplicatedBinaryActorPoisonBottle_C_ExecuteUbergraph_BP_ReplicatedBinaryActorPoisonBottle::EntryPoint' has a wrong offset!");
...
static_assert(offsetof(BP_ReplicatedBinaryActorPoisonBottle_C_ExecuteUbergraph_BP_ReplicatedBinaryActorPoisonBottle, K2Node_Event_bDoCosmetics) == 0x000005, "Member 'BP_ReplicatedBinaryActorPoisonBottle_C_ExecuteUbergraph_BP_ReplicatedBinaryActorPoisonBottle::K2Node_Event_bDoCosmetics' has a wrong offset!");
...
static_assert(offsetof(BP_ReplicatedBinaryActorPoisonBottle_C_ExecuteUbergraph_BP_ReplicatedBinaryActorPoisonBottle, K2Node_CustomEvent_Emabled) == 0x000019, "Member 'BP_ReplicatedBinaryActorPoisonBottle_C_ExecuteUbergraph_BP_ReplicatedBinaryActorPoisonBottle::K2Node_CustomEvent_Emabled' has a wrong offset!");
...
static_assert(alignof(BP_ReplicatedBinaryActorPoisonBottle_C_SetInteractionEnabled) == 0x000001, "Wrong alignment on BP_ReplicatedBinaryActorPoisonBottle_C_SetInteractionEnabled");
static_assert(sizeof(BP_ReplicatedBinaryActorPoisonBottle_C_SetInteractionEnabled) == 0x000001, "Wrong size on BP_ReplicatedBinaryActorPoisonBottle_C_SetInteractionEnabled");
static_assert(offsetof(BP_ReplicatedBinaryActorPoisonBottle_C_SetInteractionEnabled, Emabled) == 0x000000, "Member 'BP_ReplicatedBinaryActorPoisonBottle_C_SetInteractionEnabled::Emabled' has a wrong offset!");
...
struct BP_ReplicatedBinaryActorPoisonBottle_C_BndEvt__BP_ReplicatedBinaryActorWhiskeyGlass_SBZInteractable_K2Node_ComponentBoundEvent_0_SBZOnInteraction__DelegateSignature final
{
public:
...
static_assert(alignof(BP_ReplicatedBinaryActorPoisonBottle_C_OnStateChanged) == 0x000001, "Wrong alignment on BP_ReplicatedBinaryActorPoisonBottle_C_OnStateChanged");
...
static_assert(offsetof(BP_ReplicatedBinaryActorPoisonBottle_C_OnStateChanged, bStateToChangeTo) == 0x000000, "Member 'BP_ReplicatedBinaryActorPoisonBottle_C_OnStateChanged::bStateToChangeTo' has a wrong offset!");
static_assert(offsetof(BP_ReplicatedBinaryActorPoisonBottle_C_OnStateChanged, bDoCosmetics) == 0x000001, "Member 'BP_ReplicatedBinaryActorPoisonBottle_C_OnStateChanged::bDoCosmetics' has a wrong offset!");
