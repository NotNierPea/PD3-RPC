...
static_assert(sizeof(UControlRigBlueprintGeneratedClass) == 0x000348, "Wrong size on UControlRigBlueprintGeneratedClass");
...
static_assert(offsetof(UControlRigComponent, bShowDebugDrawing) == 0x00056D, "Member 'UControlRigComponent::bShowDebugDrawing' has a wrong offset!");
...
static_assert(sizeof(UControlRigSequence) == 0x000238, "Wrong size on UControlRigSequence");
static_assert(offsetof(UControlRigSequence, LastExportedToAnimationSequence) == 0x0001D0, "Member 'UControlRigSequence::LastExportedToAnimationSequence' has a wrong offset!");
static_assert(offsetof(UControlRigSequence, LastExportedUsingSkeletalMesh) == 0x000200, "Member 'UControlRigSequence::LastExportedUsingSkeletalMesh' has a wrong offset!");
static_assert(offsetof(UControlRigSequence, LastExportedFrameRate) == 0x000230, "Member 'UControlRigSequence::LastExportedFrameRate' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneControlRigParameterSection) == 0x0002F0, "Wrong size on UMovieSceneControlRigParameterSection");
...
static_assert(offsetof(UMovieSceneControlRigParameterSection, ControlRigClass) == 0x000158, "Member 'UMovieSceneControlRigParameterSection::ControlRigClass' has a wrong offset!");
...
static_assert(offsetof(UMovieSceneControlRigParameterSection, EnumParameterNamesAndCurves) == 0x000268, "Member 'UMovieSceneControlRigParameterSection::EnumParameterNamesAndCurves' has a wrong offset!");
static_assert(offsetof(UMovieSceneControlRigParameterSection, IntegerParameterNamesAndCurves) == 0x000278, "Member 'UMovieSceneControlRigParameterSection::IntegerParameterNamesAndCurves' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneControlRigParameterTrack) == 0x0000D8, "Wrong size on UMovieSceneControlRigParameterTrack");
static_assert(offsetof(UMovieSceneControlRigParameterTrack, ControlRig) == 0x0000A8, "Member 'UMovieSceneControlRigParameterTrack::ControlRig' has a wrong offset!");
static_assert(offsetof(UMovieSceneControlRigParameterTrack, SectionToKey) == 0x0000B0, "Member 'UMovieSceneControlRigParameterTrack::SectionToKey' has a wrong offset!");
static_assert(offsetof(UMovieSceneControlRigParameterTrack, Sections) == 0x0000B8, "Member 'UMovieSceneControlRigParameterTrack::Sections' has a wrong offset!");
static_assert(offsetof(UMovieSceneControlRigParameterTrack, TrackName) == 0x0000C8, "Member 'UMovieSceneControlRigParameterTrack::TrackName' has a wrong offset!");
