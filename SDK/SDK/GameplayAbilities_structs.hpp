...
static_assert(sizeof(FGameplayEffectSpecForRPC) == 0x000080, "Wrong size on FGameplayEffectSpecForRPC");
...
static_assert(offsetof(FGameplayEffectSpecForRPC, Duration) == 0x000074, "Member 'FGameplayEffectSpecForRPC::Duration' has a wrong offset!");
static_assert(offsetof(FGameplayEffectSpecForRPC, AbilityLevel) == 0x000078, "Member 'FGameplayEffectSpecForRPC::AbilityLevel' has a wrong offset!");
...
static_assert(offsetof(FGameplayCueParameters, OriginalDuration) == 0x0000B4, "Member 'FGameplayCueParameters::OriginalDuration' has a wrong offset!");
static_assert(offsetof(FGameplayCueParameters, AbilityLevel) == 0x0000B8, "Member 'FGameplayCueParameters::AbilityLevel' has a wrong offset!");
static_assert(offsetof(FGameplayCueParameters, TargetAttachComponent) == 0x0000BC, "Member 'FGameplayCueParameters::TargetAttachComponent' has a wrong offset!");
static_assert(offsetof(FGameplayCueParameters, bReplicateLocationWhenUsingMinimalRepProxy) == 0x0000C4, "Member 'FGameplayCueParameters::bReplicateLocationWhenUsingMinimalRepProxy' has a wrong offset!");
...
static_assert(sizeof(FGameplayAbilitySpecDef) == 0x0000A8, "Wrong size on FGameplayAbilitySpecDef");
...
static_assert(offsetof(FGameplayAbilitySpecDef, InputID) == 0x000040, "Member 'FGameplayAbilitySpecDef::InputID' has a wrong offset!");
static_assert(offsetof(FGameplayAbilitySpecDef, RemovalPolicy) == 0x000044, "Member 'FGameplayAbilitySpecDef::RemovalPolicy' has a wrong offset!");
static_assert(offsetof(FGameplayAbilitySpecDef, SourceObject) == 0x000048, "Member 'FGameplayAbilitySpecDef::SourceObject' has a wrong offset!");
static_assert(offsetof(FGameplayAbilitySpecDef, AssignedHandle) == 0x0000A0, "Member 'FGameplayAbilitySpecDef::AssignedHandle' has a wrong offset!");
...
static_assert(offsetof(FMinimalGameplayCueReplicationProxy, Owner) == 0x000300, "Member 'FMinimalGameplayCueReplicationProxy::Owner' has a wrong offset!");
...
static_assert(sizeof(FAttributeBasedFloat) == 0x000148, "Wrong size on FAttributeBasedFloat");
...
static_assert(offsetof(FAttributeBasedFloat, AttributeCurve) == 0x0000E8, "Member 'FAttributeBasedFloat::AttributeCurve' has a wrong offset!");
static_assert(offsetof(FAttributeBasedFloat, AttributeCalculationType) == 0x000100, "Member 'FAttributeBasedFloat::AttributeCalculationType' has a wrong offset!");
static_assert(offsetof(FAttributeBasedFloat, FinalChannel) == 0x000101, "Member 'FAttributeBasedFloat::FinalChannel' has a wrong offset!");
static_assert(offsetof(FAttributeBasedFloat, SourceTagFilter) == 0x000108, "Member 'FAttributeBasedFloat::SourceTagFilter' has a wrong offset!");
static_assert(offsetof(FAttributeBasedFloat, TargetTagFilter) == 0x000128, "Member 'FAttributeBasedFloat::TargetTagFilter' has a wrong offset!");
...
static_assert(offsetof(FGameplayEffectModifierMagnitude, CustomMagnitude) == 0x000188, "Member 'FGameplayEffectModifierMagnitude::CustomMagnitude' has a wrong offset!");
static_assert(offsetof(FGameplayEffectModifierMagnitude, SetByCallerMagnitude) == 0x000250, "Member 'FGameplayEffectModifierMagnitude::SetByCallerMagnitude' has a wrong offset!");
...
static_assert(offsetof(FGameplayModifierInfo, ModifierMagnitude) == 0x000078, "Member 'FGameplayModifierInfo::ModifierMagnitude' has a wrong offset!");
static_assert(offsetof(FGameplayModifierInfo, EvaluationChannelSettings) == 0x0002E0, "Member 'FGameplayModifierInfo::EvaluationChannelSettings' has a wrong offset!");
static_assert(offsetof(FGameplayModifierInfo, SourceTags) == 0x0002E8, "Member 'FGameplayModifierInfo::SourceTags' has a wrong offset!");
static_assert(offsetof(FGameplayModifierInfo, TargetTags) == 0x000328, "Member 'FGameplayModifierInfo::TargetTags' has a wrong offset!");
...
static_assert(offsetof(FGameplayEffectExecutionScopedModifierInfo, AggregatorType) == 0x00004C, "Member 'FGameplayEffectExecutionScopedModifierInfo::AggregatorType' has a wrong offset!");
static_assert(offsetof(FGameplayEffectExecutionScopedModifierInfo, ModifierOp) == 0x00004D, "Member 'FGameplayEffectExecutionScopedModifierInfo::ModifierOp' has a wrong offset!");
...
static_assert(offsetof(FGameplayEffectExecutionScopedModifierInfo, EvaluationChannelSettings) == 0x0002B8, "Member 'FGameplayEffectExecutionScopedModifierInfo::EvaluationChannelSettings' has a wrong offset!");
static_assert(offsetof(FGameplayEffectExecutionScopedModifierInfo, SourceTags) == 0x0002C0, "Member 'FGameplayEffectExecutionScopedModifierInfo::SourceTags' has a wrong offset!");
static_assert(offsetof(FGameplayEffectExecutionScopedModifierInfo, TargetTags) == 0x000300, "Member 'FGameplayEffectExecutionScopedModifierInfo::TargetTags' has a wrong offset!");
...
static_assert(sizeof(FConditionalGameplayEffect) == 0x000030, "Wrong size on FConditionalGameplayEffect");
...
static_assert(offsetof(FConditionalGameplayEffect, bUseOriginalContext) == 0x000028, "Member 'FConditionalGameplayEffect::bUseOriginalContext' has a wrong offset!");
...
static_assert(sizeof(FMovieSceneGameplayCueKey) == 0x000080, "Wrong size on FMovieSceneGameplayCueKey");
static_assert(offsetof(FMovieSceneGameplayCueKey, Cue) == 0x000000, "Member 'FMovieSceneGameplayCueKey::Cue' has a wrong offset!");
static_assert(offsetof(FMovieSceneGameplayCueKey, Location) == 0x00000C, "Member 'FMovieSceneGameplayCueKey::Location' has a wrong offset!");
static_assert(offsetof(FMovieSceneGameplayCueKey, Normal) == 0x000018, "Member 'FMovieSceneGameplayCueKey::Normal' has a wrong offset!");
static_assert(offsetof(FMovieSceneGameplayCueKey, AttachSocketName) == 0x000024, "Member 'FMovieSceneGameplayCueKey::AttachSocketName' has a wrong offset!");
static_assert(offsetof(FMovieSceneGameplayCueKey, NormalizedMagnitude) == 0x000030, "Member 'FMovieSceneGameplayCueKey::NormalizedMagnitude' has a wrong offset!");
static_assert(offsetof(FMovieSceneGameplayCueKey, Instigator) == 0x000034, "Member 'FMovieSceneGameplayCueKey::Instigator' has a wrong offset!");
static_assert(offsetof(FMovieSceneGameplayCueKey, EffectCauser) == 0x00004C, "Member 'FMovieSceneGameplayCueKey::EffectCauser' has a wrong offset!");
static_assert(offsetof(FMovieSceneGameplayCueKey, PhysicalMaterial) == 0x000068, "Member 'FMovieSceneGameplayCueKey::PhysicalMaterial' has a wrong offset!");
static_assert(offsetof(FMovieSceneGameplayCueKey, GameplayEffectLevel) == 0x000070, "Member 'FMovieSceneGameplayCueKey::GameplayEffectLevel' has a wrong offset!");
static_assert(offsetof(FMovieSceneGameplayCueKey, AbilityLevel) == 0x000074, "Member 'FMovieSceneGameplayCueKey::AbilityLevel' has a wrong offset!");
static_assert(offsetof(FMovieSceneGameplayCueKey, bAttachToBinding) == 0x000078, "Member 'FMovieSceneGameplayCueKey::bAttachToBinding' has a wrong offset!");
