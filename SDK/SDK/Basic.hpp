...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0716B3B0;
	constexpr int32 AppendString      = 0x01A06530;
	constexpr int32 GNames            = 0x07113500;
	constexpr int32 GWorld            = 0x072C0DC0;
	constexpr int32 ProcessEvent      = 0x01C01DA0;
