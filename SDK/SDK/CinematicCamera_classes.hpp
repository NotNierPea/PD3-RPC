...
static_assert(offsetof(ACineCameraActor, LookatTrackingSettings) == 0x000850, "Member 'ACineCameraActor::LookatTrackingSettings' has a wrong offset!");
...
static_assert(offsetof(UCineCameraComponent, CurrentFocalLength) == 0x0008A8, "Member 'UCineCameraComponent::CurrentFocalLength' has a wrong offset!");
static_assert(offsetof(UCineCameraComponent, CurrentAperture) == 0x0008AC, "Member 'UCineCameraComponent::CurrentAperture' has a wrong offset!");
static_assert(offsetof(UCineCameraComponent, TopPassCurrentAperture) == 0x0008B0, "Member 'UCineCameraComponent::TopPassCurrentAperture' has a wrong offset!");
static_assert(offsetof(UCineCameraComponent, CurrentFocusDistance) == 0x0008B4, "Member 'UCineCameraComponent::CurrentFocusDistance' has a wrong offset!");
static_assert(offsetof(UCineCameraComponent, FilmbackPresets) == 0x0008C0, "Member 'UCineCameraComponent::FilmbackPresets' has a wrong offset!");
static_assert(offsetof(UCineCameraComponent, LensPresets) == 0x0008D0, "Member 'UCineCameraComponent::LensPresets' has a wrong offset!");
static_assert(offsetof(UCineCameraComponent, DefaultFilmbackPresetName) == 0x0008E0, "Member 'UCineCameraComponent::DefaultFilmbackPresetName' has a wrong offset!");
static_assert(offsetof(UCineCameraComponent, DefaultFilmbackPreset) == 0x0008F0, "Member 'UCineCameraComponent::DefaultFilmbackPreset' has a wrong offset!");
