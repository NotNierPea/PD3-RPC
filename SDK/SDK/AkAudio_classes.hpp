...
static_assert(offsetof(UAkGameObject, AkAudioEvent) == 0x000228, "Member 'UAkGameObject::AkAudioEvent' has a wrong offset!");
static_assert(offsetof(UAkGameObject, EventName) == 0x000230, "Member 'UAkGameObject::EventName' has a wrong offset!");
...
static_assert(offsetof(UAkRoomComponent, GeometryComponent) == 0x000268, "Member 'UAkRoomComponent::GeometryComponent' has a wrong offset!");
...
static_assert(sizeof(UAkPortalComponent) == 0x0002F0, "Wrong size on UAkPortalComponent");
static_assert(offsetof(UAkPortalComponent, bDynamic) == 0x000228, "Member 'UAkPortalComponent::bDynamic' has a wrong offset!");
static_assert(offsetof(UAkPortalComponent, InitialState) == 0x000229, "Member 'UAkPortalComponent::InitialState' has a wrong offset!");
static_assert(offsetof(UAkPortalComponent, ObstructionRefreshInterval) == 0x00022C, "Member 'UAkPortalComponent::ObstructionRefreshInterval' has a wrong offset!");
static_assert(offsetof(UAkPortalComponent, ObstructionCollisionChannel) == 0x000230, "Member 'UAkPortalComponent::ObstructionCollisionChannel' has a wrong offset!");
...
static_assert(sizeof(UAkAcousticTextureSetComponent) == 0x000240, "Wrong size on UAkAcousticTextureSetComponent");
...
static_assert(sizeof(UAkSettings) == 0x000328, "Wrong size on UAkSettings");
...
static_assert(offsetof(UAkSettings, DefaultFitToGeometryCollisionChannel) == 0x00005A, "Member 'UAkSettings::DefaultFitToGeometryCollisionChannel' has a wrong offset!");
static_assert(offsetof(UAkSettings, AkGeometryMap) == 0x000060, "Member 'UAkSettings::AkGeometryMap' has a wrong offset!");
static_assert(offsetof(UAkSettings, GlobalDecayAbsorption) == 0x0000B0, "Member 'UAkSettings::GlobalDecayAbsorption' has a wrong offset!");
static_assert(offsetof(UAkSettings, DefaultReverbAuxBus) == 0x0000B8, "Member 'UAkSettings::DefaultReverbAuxBus' has a wrong offset!");
...
static_assert(offsetof(UAkSettings, DecayEstimateRTPC) == 0x000198, "Member 'UAkSettings::DecayEstimateRTPC' has a wrong offset!");
static_assert(offsetof(UAkSettings, TimeToFirstReflectionRTPC) == 0x0001C8, "Member 'UAkSettings::TimeToFirstReflectionRTPC' has a wrong offset!");
static_assert(offsetof(UAkSettings, AudioInputEvent) == 0x0001F8, "Member 'UAkSettings::AudioInputEvent' has a wrong offset!");
...
static_assert(offsetof(UAkSettings, EnableAutomaticAssetSynchronization) == 0x00027B, "Member 'UAkSettings::EnableAutomaticAssetSynchronization' has a wrong offset!");
...
static_assert(offsetof(UAkSettings, AskedToUseNewAssetManagement) == 0x0002E0, "Member 'UAkSettings::AskedToUseNewAssetManagement' has a wrong offset!");
static_assert(offsetof(UAkSettings, bEnableMultiCoreRendering) == 0x0002E1, "Member 'UAkSettings::bEnableMultiCoreRendering' has a wrong offset!");
static_assert(offsetof(UAkSettings, MigratedEnableMultiCoreRendering) == 0x0002E2, "Member 'UAkSettings::MigratedEnableMultiCoreRendering' has a wrong offset!");
static_assert(offsetof(UAkSettings, FixupRedirectorsDuringMigration) == 0x0002E3, "Member 'UAkSettings::FixupRedirectorsDuringMigration' has a wrong offset!");
static_assert(offsetof(UAkSettings, WwiseWindowsInstallationPath) == 0x0002E8, "Member 'UAkSettings::WwiseWindowsInstallationPath' has a wrong offset!");
static_assert(offsetof(UAkSettings, WwiseMacInstallationPath) == 0x0002F8, "Member 'UAkSettings::WwiseMacInstallationPath' has a wrong offset!");
static_assert(offsetof(UAkSettings, MemoryBudget) == 0x000308, "Member 'UAkSettings::MemoryBudget' has a wrong offset!");
static_assert(offsetof(UAkSettings, MasterVolumeRTPC) == 0x000310, "Member 'UAkSettings::MasterVolumeRTPC' has a wrong offset!");
...
static_assert(sizeof(UAkAssetData) == 0x000080, "Wrong size on UAkAssetData");
static_assert(offsetof(UAkAssetData, CachedHash) == 0x000030, "Member 'UAkAssetData::CachedHash' has a wrong offset!");
static_assert(offsetof(UAkAssetData, BankLanguage) == 0x000038, "Member 'UAkAssetData::BankLanguage' has a wrong offset!");
...
static_assert(sizeof(UAkAssetDataWithMedia) == 0x000090, "Wrong size on UAkAssetDataWithMedia");
static_assert(offsetof(UAkAssetDataWithMedia, MediaList) == 0x000080, "Member 'UAkAssetDataWithMedia::MediaList' has a wrong offset!");
...
static_assert(sizeof(UAkAssetDataSwitchContainerData) == 0x000088, "Wrong size on UAkAssetDataSwitchContainerData");
...
static_assert(offsetof(UAkAssetDataSwitchContainerData, DefaultGroupValue) == 0x000060, "Member 'UAkAssetDataSwitchContainerData::DefaultGroupValue' has a wrong offset!");
static_assert(offsetof(UAkAssetDataSwitchContainerData, MediaList) == 0x000068, "Member 'UAkAssetDataSwitchContainerData::MediaList' has a wrong offset!");
static_assert(offsetof(UAkAssetDataSwitchContainerData, Children) == 0x000078, "Member 'UAkAssetDataSwitchContainerData::Children' has a wrong offset!");
...
static_assert(sizeof(UAkAssetDataSwitchContainer) == 0x0000F8, "Wrong size on UAkAssetDataSwitchContainer");
static_assert(offsetof(UAkAssetDataSwitchContainer, SwitchContainers) == 0x000090, "Member 'UAkAssetDataSwitchContainer::SwitchContainers' has a wrong offset!");
static_assert(offsetof(UAkAssetDataSwitchContainer, DefaultGroupValue) == 0x0000A0, "Member 'UAkAssetDataSwitchContainer::DefaultGroupValue' has a wrong offset!");
...
static_assert(sizeof(UAkAudioEventData) == 0x000298, "Wrong size on UAkAudioEventData");
static_assert(offsetof(UAkAudioEventData, MaxAttenuationRadius) == 0x0000F8, "Member 'UAkAudioEventData::MaxAttenuationRadius' has a wrong offset!");
static_assert(offsetof(UAkAudioEventData, IsInfinite) == 0x0000FC, "Member 'UAkAudioEventData::IsInfinite' has a wrong offset!");
static_assert(offsetof(UAkAudioEventData, MinimumDuration) == 0x000100, "Member 'UAkAudioEventData::MinimumDuration' has a wrong offset!");
static_assert(offsetof(UAkAudioEventData, MaximumDuration) == 0x000104, "Member 'UAkAudioEventData::MaximumDuration' has a wrong offset!");
static_assert(offsetof(UAkAudioEventData, LocalizedMedia) == 0x000108, "Member 'UAkAudioEventData::LocalizedMedia' has a wrong offset!");
static_assert(offsetof(UAkAudioEventData, PostedEvents) == 0x000158, "Member 'UAkAudioEventData::PostedEvents' has a wrong offset!");
static_assert(offsetof(UAkAudioEventData, UserDefinedSends) == 0x0001A8, "Member 'UAkAudioEventData::UserDefinedSends' has a wrong offset!");
static_assert(offsetof(UAkAudioEventData, PostedTriggers) == 0x0001F8, "Member 'UAkAudioEventData::PostedTriggers' has a wrong offset!");
static_assert(offsetof(UAkAudioEventData, GroupValues) == 0x000248, "Member 'UAkAudioEventData::GroupValues' has a wrong offset!");
...
static_assert(sizeof(UAkAudioBank) == 0x000120, "Wrong size on UAkAudioBank");
static_assert(offsetof(UAkAudioBank, AutoLoad) == 0x000058, "Member 'UAkAudioBank::AutoLoad' has a wrong offset!");
static_assert(offsetof(UAkAudioBank, LocalizedPlatformAssetDataMap) == 0x000060, "Member 'UAkAudioBank::LocalizedPlatformAssetDataMap' has a wrong offset!");
static_assert(offsetof(UAkAudioBank, LinkedAkEvents) == 0x0000B0, "Member 'UAkAudioBank::LinkedAkEvents' has a wrong offset!");
static_assert(offsetof(UAkAudioBank, CurrentLocalizedPlatformAssetData) == 0x000100, "Member 'UAkAudioBank::CurrentLocalizedPlatformAssetData' has a wrong offset!");
...
static_assert(offsetof(UAkAudioEvent, CurrentLocalizedPlatformData) == 0x0000B8, "Member 'UAkAudioEvent::CurrentLocalizedPlatformData' has a wrong offset!");
static_assert(offsetof(UAkAudioEvent, MaxAttenuationRadius) == 0x0000C0, "Member 'UAkAudioEvent::MaxAttenuationRadius' has a wrong offset!");
static_assert(offsetof(UAkAudioEvent, IsInfinite) == 0x0000C4, "Member 'UAkAudioEvent::IsInfinite' has a wrong offset!");
static_assert(offsetof(UAkAudioEvent, MinimumDuration) == 0x0000C8, "Member 'UAkAudioEvent::MinimumDuration' has a wrong offset!");
static_assert(offsetof(UAkAudioEvent, MaximumDuration) == 0x0000CC, "Member 'UAkAudioEvent::MaximumDuration' has a wrong offset!");
...
static_assert(sizeof(UAkComponent) == 0x000440, "Wrong size on UAkComponent");
...
static_assert(offsetof(UAkComponent, EnableSpotReflectors) == 0x000251, "Member 'UAkComponent::EnableSpotReflectors' has a wrong offset!");
static_assert(offsetof(UAkComponent, outerRadius) == 0x000254, "Member 'UAkComponent::outerRadius' has a wrong offset!");
static_assert(offsetof(UAkComponent, innerRadius) == 0x000258, "Member 'UAkComponent::innerRadius' has a wrong offset!");
static_assert(offsetof(UAkComponent, EarlyReflectionAuxBus) == 0x000260, "Member 'UAkComponent::EarlyReflectionAuxBus' has a wrong offset!");
static_assert(offsetof(UAkComponent, EarlyReflectionAuxBusName) == 0x000268, "Member 'UAkComponent::EarlyReflectionAuxBusName' has a wrong offset!");
static_assert(offsetof(UAkComponent, EarlyReflectionOrder) == 0x000278, "Member 'UAkComponent::EarlyReflectionOrder' has a wrong offset!");
static_assert(offsetof(UAkComponent, EarlyReflectionBusSendGain) == 0x00027C, "Member 'UAkComponent::EarlyReflectionBusSendGain' has a wrong offset!");
static_assert(offsetof(UAkComponent, EarlyReflectionMaxPathLength) == 0x000280, "Member 'UAkComponent::EarlyReflectionMaxPathLength' has a wrong offset!");
static_assert(offsetof(UAkComponent, roomReverbAuxBusGain) == 0x000284, "Member 'UAkComponent::roomReverbAuxBusGain' has a wrong offset!");
static_assert(offsetof(UAkComponent, diffractionMaxEdges) == 0x000288, "Member 'UAkComponent::diffractionMaxEdges' has a wrong offset!");
static_assert(offsetof(UAkComponent, diffractionMaxPaths) == 0x00028C, "Member 'UAkComponent::diffractionMaxPaths' has a wrong offset!");
static_assert(offsetof(UAkComponent, diffractionMaxPathLength) == 0x000290, "Member 'UAkComponent::diffractionMaxPathLength' has a wrong offset!");
...
static_assert(offsetof(UAkComponent, MinDistanceThresholdForUpdate) == 0x000298, "Member 'UAkComponent::MinDistanceThresholdForUpdate' has a wrong offset!");
static_assert(offsetof(UAkComponent, MinUpdateTime) == 0x00029C, "Member 'UAkComponent::MinUpdateTime' has a wrong offset!");
static_assert(offsetof(UAkComponent, bAutoDeactivate) == 0x0002A0, "Member 'UAkComponent::bAutoDeactivate' has a wrong offset!");
static_assert(offsetof(UAkComponent, StopWhenOwnerDestroyed) == 0x0002A1, "Member 'UAkComponent::StopWhenOwnerDestroyed' has a wrong offset!");
static_assert(offsetof(UAkComponent, AttenuationScalingFactor) == 0x0002A4, "Member 'UAkComponent::AttenuationScalingFactor' has a wrong offset!");
static_assert(offsetof(UAkComponent, OcclusionRefreshInterval) == 0x0002A8, "Member 'UAkComponent::OcclusionRefreshInterval' has a wrong offset!");
static_assert(offsetof(UAkComponent, bUseReverbVolumes) == 0x0002AC, "Member 'UAkComponent::bUseReverbVolumes' has a wrong offset!");
...
static_assert(sizeof(UAkAudioInputComponent) == 0x000470, "Wrong size on UAkAudioInputComponent");
...
static_assert(sizeof(UAkGeometryComponent) == 0x0003D0, "Wrong size on UAkGeometryComponent");
static_assert(offsetof(UAkGeometryComponent, MeshType) == 0x000240, "Member 'UAkGeometryComponent::MeshType' has a wrong offset!");
static_assert(offsetof(UAkGeometryComponent, LOD) == 0x000244, "Member 'UAkGeometryComponent::LOD' has a wrong offset!");
static_assert(offsetof(UAkGeometryComponent, WeldingThreshold) == 0x000248, "Member 'UAkGeometryComponent::WeldingThreshold' has a wrong offset!");
static_assert(offsetof(UAkGeometryComponent, StaticMeshSurfaceOverride) == 0x000250, "Member 'UAkGeometryComponent::StaticMeshSurfaceOverride' has a wrong offset!");
static_assert(offsetof(UAkGeometryComponent, CollisionMeshSurfaceOverride) == 0x0002A0, "Member 'UAkGeometryComponent::CollisionMeshSurfaceOverride' has a wrong offset!");
static_assert(offsetof(UAkGeometryComponent, bEnableDiffraction) == 0x0002B8, "Member 'UAkGeometryComponent::bEnableDiffraction' has a wrong offset!");
static_assert(offsetof(UAkGeometryComponent, bEnableDiffractionOnBoundaryEdges) == 0x0002B9, "Member 'UAkGeometryComponent::bEnableDiffractionOnBoundaryEdges' has a wrong offset!");
static_assert(offsetof(UAkGeometryComponent, AssociatedRoom) == 0x0002C0, "Member 'UAkGeometryComponent::AssociatedRoom' has a wrong offset!");
static_assert(offsetof(UAkGeometryComponent, GeometryData) == 0x0002D8, "Member 'UAkGeometryComponent::GeometryData' has a wrong offset!");
static_assert(offsetof(UAkGeometryComponent, SurfaceAreas) == 0x000328, "Member 'UAkGeometryComponent::SurfaceAreas' has a wrong offset!");
...
static_assert(sizeof(UAkInitBankAssetData) == 0x0000A0, "Wrong size on UAkInitBankAssetData");
static_assert(offsetof(UAkInitBankAssetData, PluginInfos) == 0x000090, "Member 'UAkInitBankAssetData::PluginInfos' has a wrong offset!");
...
static_assert(offsetof(UAkLateReverbComponent, bEnable) == 0x000228, "Member 'UAkLateReverbComponent::bEnable' has a wrong offset!");
static_assert(offsetof(UAkLateReverbComponent, SendLevel) == 0x00022C, "Member 'UAkLateReverbComponent::SendLevel' has a wrong offset!");
static_assert(offsetof(UAkLateReverbComponent, FadeRate) == 0x000230, "Member 'UAkLateReverbComponent::FadeRate' has a wrong offset!");
static_assert(offsetof(UAkLateReverbComponent, Priority) == 0x000234, "Member 'UAkLateReverbComponent::Priority' has a wrong offset!");
static_assert(offsetof(UAkLateReverbComponent, AutoAssignAuxBus) == 0x000238, "Member 'UAkLateReverbComponent::AutoAssignAuxBus' has a wrong offset!");
...
static_assert(offsetof(UAkLateReverbComponent, AuxBusManual) == 0x000260, "Member 'UAkLateReverbComponent::AuxBusManual' has a wrong offset!");
...
static_assert(sizeof(UAkMediaAssetData) == 0x000080, "Wrong size on UAkMediaAssetData");
...
static_assert(offsetof(UAkMediaAssetData, Language) == 0x000038, "Member 'UAkMediaAssetData::Language' has a wrong offset!");
static_assert(offsetof(UAkMediaAssetData, AssetPlatform) == 0x000048, "Member 'UAkMediaAssetData::AssetPlatform' has a wrong offset!");
...
static_assert(offsetof(UAkMediaAsset, MediaName) == 0x000038, "Member 'UAkMediaAsset::MediaName' has a wrong offset!");
static_assert(offsetof(UAkMediaAsset, AutoLoad) == 0x000048, "Member 'UAkMediaAsset::AutoLoad' has a wrong offset!");
static_assert(offsetof(UAkMediaAsset, UserData) == 0x000050, "Member 'UAkMediaAsset::UserData' has a wrong offset!");
static_assert(offsetof(UAkMediaAsset, Language) == 0x000060, "Member 'UAkMediaAsset::Language' has a wrong offset!");
static_assert(offsetof(UAkMediaAsset, CurrentMediaAssetData) == 0x000070, "Member 'UAkMediaAsset::CurrentMediaAssetData' has a wrong offset!");
...
static_assert(sizeof(UAkExternalMediaAsset) == 0x0000E0, "Wrong size on UAkExternalMediaAsset");
...
static_assert(sizeof(UAkSubmixInputComponent) == 0x0004C0, "Wrong size on UAkSubmixInputComponent");
static_assert(offsetof(UAkSubmixInputComponent, SubmixToRecord) == 0x000470, "Member 'UAkSubmixInputComponent::SubmixToRecord' has a wrong offset!");
...
static_assert(offsetof(UAkSurfaceReflectorSetComponent, bEnableSurfaceReflectors) == 0x000240, "Member 'UAkSurfaceReflectorSetComponent::bEnableSurfaceReflectors' has a wrong offset!");
static_assert(offsetof(UAkSurfaceReflectorSetComponent, AcousticPolys) == 0x000248, "Member 'UAkSurfaceReflectorSetComponent::AcousticPolys' has a wrong offset!");
static_assert(offsetof(UAkSurfaceReflectorSetComponent, bEnableDiffraction) == 0x000258, "Member 'UAkSurfaceReflectorSetComponent::bEnableDiffraction' has a wrong offset!");
static_assert(offsetof(UAkSurfaceReflectorSetComponent, bEnableDiffractionOnBoundaryEdges) == 0x000259, "Member 'UAkSurfaceReflectorSetComponent::bEnableDiffractionOnBoundaryEdges' has a wrong offset!");
static_assert(offsetof(UAkSurfaceReflectorSetComponent, AssociatedRoom) == 0x000260, "Member 'UAkSurfaceReflectorSetComponent::AssociatedRoom' has a wrong offset!");
...
static_assert(sizeof(UAkXB1InitializationSettings) == 0x000100, "Wrong size on UAkXB1InitializationSettings");
