...
static_assert(offsetof(FCameraFocusSettings, TopPassManualFocusDistance) == 0x000008, "Member 'FCameraFocusSettings::TopPassManualFocusDistance' has a wrong offset!");
static_assert(offsetof(FCameraFocusSettings, TrackingFocusSettings) == 0x000010, "Member 'FCameraFocusSettings::TrackingFocusSettings' has a wrong offset!");
