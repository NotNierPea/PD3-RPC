...
static_assert(offsetof(ChromaSDKPluginBPLibrary_GetAnimationIdByIndex, index) == 0x000000, "Member 'ChromaSDKPluginBPLibrary_GetAnimationIdByIndex::index' has a wrong offset!");
...
static_assert(offsetof(ChromaSDKPluginBPLibrary_GetPlayingAnimationId, index) == 0x000000, "Member 'ChromaSDKPluginBPLibrary_GetPlayingAnimationId::index' has a wrong offset!");
...
static_assert(offsetof(ChromaSDKPluginBPLibrary_SetEventName, name) == 0x000000, "Member 'ChromaSDKPluginBPLibrary_SetEventName::name' has a wrong offset!");
...
static_assert(alignof(ChromaSDKPluginBPLibrary_SetIdleAnimation) == 0x000004, "Wrong alignment on ChromaSDKPluginBPLibrary_SetIdleAnimation");
static_assert(sizeof(ChromaSDKPluginBPLibrary_SetIdleAnimation) == 0x000004, "Wrong size on ChromaSDKPluginBPLibrary_SetIdleAnimation");
static_assert(offsetof(ChromaSDKPluginBPLibrary_SetIdleAnimation, AnimationId) == 0x000000, "Member 'ChromaSDKPluginBPLibrary_SetIdleAnimation::AnimationId' has a wrong offset!");
