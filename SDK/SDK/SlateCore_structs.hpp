...
static_assert(offsetof(FSlateFontInfo, Kerning) == 0x000054, "Member 'FSlateFontInfo::Kerning' has a wrong offset!");
...
static_assert(sizeof(FTextBlockStyle) == 0x000290, "Wrong size on FTextBlockStyle");
...
static_assert(offsetof(FTextBlockStyle, ShadowOffset) == 0x000090, "Member 'FTextBlockStyle::ShadowOffset' has a wrong offset!");
static_assert(offsetof(FTextBlockStyle, ShadowColorAndOpacity) == 0x000098, "Member 'FTextBlockStyle::ShadowColorAndOpacity' has a wrong offset!");
static_assert(offsetof(FTextBlockStyle, SelectedBackgroundColor) == 0x0000A8, "Member 'FTextBlockStyle::SelectedBackgroundColor' has a wrong offset!");
static_assert(offsetof(FTextBlockStyle, HighlightColor) == 0x0000D0, "Member 'FTextBlockStyle::HighlightColor' has a wrong offset!");
static_assert(offsetof(FTextBlockStyle, HighlightShape) == 0x0000E0, "Member 'FTextBlockStyle::HighlightShape' has a wrong offset!");
static_assert(offsetof(FTextBlockStyle, StrikeBrush) == 0x000170, "Member 'FTextBlockStyle::StrikeBrush' has a wrong offset!");
static_assert(offsetof(FTextBlockStyle, UnderlineBrush) == 0x000200, "Member 'FTextBlockStyle::UnderlineBrush' has a wrong offset!");
...
static_assert(sizeof(FEditableTextStyle) == 0x000240, "Wrong size on FEditableTextStyle");
...
static_assert(offsetof(FEditableTextStyle, BackgroundImageComposing) == 0x000120, "Member 'FEditableTextStyle::BackgroundImageComposing' has a wrong offset!");
static_assert(offsetof(FEditableTextStyle, CaretImage) == 0x0001B0, "Member 'FEditableTextStyle::CaretImage' has a wrong offset!");
...
static_assert(sizeof(FEditableTextBoxStyle) == 0x000868, "Wrong size on FEditableTextBoxStyle");
...
static_assert(offsetof(FEditableTextBoxStyle, ForegroundColor) == 0x0002B8, "Member 'FEditableTextBoxStyle::ForegroundColor' has a wrong offset!");
static_assert(offsetof(FEditableTextBoxStyle, BackgroundColor) == 0x0002E0, "Member 'FEditableTextBoxStyle::BackgroundColor' has a wrong offset!");
static_assert(offsetof(FEditableTextBoxStyle, ReadOnlyForegroundColor) == 0x000308, "Member 'FEditableTextBoxStyle::ReadOnlyForegroundColor' has a wrong offset!");
static_assert(offsetof(FEditableTextBoxStyle, HScrollBarPadding) == 0x000330, "Member 'FEditableTextBoxStyle::HScrollBarPadding' has a wrong offset!");
static_assert(offsetof(FEditableTextBoxStyle, VScrollBarPadding) == 0x000340, "Member 'FEditableTextBoxStyle::VScrollBarPadding' has a wrong offset!");
static_assert(offsetof(FEditableTextBoxStyle, ScrollBarStyle) == 0x000350, "Member 'FEditableTextBoxStyle::ScrollBarStyle' has a wrong offset!");
...
static_assert(sizeof(FWindowStyle) == 0x001178, "Wrong size on FWindowStyle");
...
static_assert(offsetof(FWindowStyle, ActiveTitleBrush) == 0x000D38, "Member 'FWindowStyle::ActiveTitleBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, InactiveTitleBrush) == 0x000DC8, "Member 'FWindowStyle::InactiveTitleBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, FlashTitleBrush) == 0x000E58, "Member 'FWindowStyle::FlashTitleBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, BackgroundColor) == 0x000EE8, "Member 'FWindowStyle::BackgroundColor' has a wrong offset!");
static_assert(offsetof(FWindowStyle, OutlineBrush) == 0x000F10, "Member 'FWindowStyle::OutlineBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, OutlineColor) == 0x000FA0, "Member 'FWindowStyle::OutlineColor' has a wrong offset!");
static_assert(offsetof(FWindowStyle, BorderBrush) == 0x000FC8, "Member 'FWindowStyle::BorderBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, BackgroundBrush) == 0x001058, "Member 'FWindowStyle::BackgroundBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, ChildBackgroundBrush) == 0x0010E8, "Member 'FWindowStyle::ChildBackgroundBrush' has a wrong offset!");
...
static_assert(sizeof(FSearchBoxStyle) == 0x000B28, "Wrong size on FSearchBoxStyle");
static_assert(offsetof(FSearchBoxStyle, TextBoxStyle) == 0x000008, "Member 'FSearchBoxStyle::TextBoxStyle' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, ActiveFontInfo) == 0x000870, "Member 'FSearchBoxStyle::ActiveFontInfo' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, UpArrowImage) == 0x0008D0, "Member 'FSearchBoxStyle::UpArrowImage' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, DownArrowImage) == 0x000960, "Member 'FSearchBoxStyle::DownArrowImage' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, GlassImage) == 0x0009F0, "Member 'FSearchBoxStyle::GlassImage' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, ClearImage) == 0x000A80, "Member 'FSearchBoxStyle::ClearImage' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, ImagePadding) == 0x000B10, "Member 'FSearchBoxStyle::ImagePadding' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, bLeftAlignButtons) == 0x000B20, "Member 'FSearchBoxStyle::bLeftAlignButtons' has a wrong offset!");
...
static_assert(sizeof(FInlineEditableTextBlockStyle) == 0x000B00, "Wrong size on FInlineEditableTextBlockStyle");
...
static_assert(offsetof(FInlineEditableTextBlockStyle, TextStyle) == 0x000870, "Member 'FInlineEditableTextBlockStyle::TextStyle' has a wrong offset!");
...
static_assert(sizeof(FHyperlinkStyle) == 0x000550, "Wrong size on FHyperlinkStyle");
...
static_assert(offsetof(FHyperlinkStyle, Padding) == 0x000540, "Member 'FHyperlinkStyle::Padding' has a wrong offset!");
